...
SIGNAL \f_control|i_floor_call_array_down[7]~feeder_combout\ : std_logic;
...
SIGNAL \f_control|i_floor_call_array_down[5]~feeder_combout\ : std_logic;
...
SIGNAL \state_mach|floor_call~DUPLICATE_q\ : std_logic;
...
SIGNAL \f_control|i_destination_array[4]~feeder_combout\ : std_logic;
SIGNAL \f_control|i_destination_array~14_combout\ : std_logic;
SIGNAL \f_control|i_destination_array~15_combout\ : std_logic;
SIGNAL \f_control|i_destination_array[7]~feeder_combout\ : std_logic;
...
SIGNAL \state_mach|floor_stop~DUPLICATE_q\ : std_logic;
SIGNAL \state_mach|i_current_floor~0_combout\ : std_logic;
SIGNAL \state_mach|i_current_floor[0]~DUPLICATE_q\ : std_logic;
...
SIGNAL \state_mach|destination~DUPLICATE_q\ : std_logic;
...
SIGNAL \state_mach|current_state.up~DUPLICATE_q\ : std_logic;
...
SIGNAL \state_mach|ALT_INV_destination~DUPLICATE_q\ : std_logic;
SIGNAL \state_mach|ALT_INV_floor_call~DUPLICATE_q\ : std_logic;
SIGNAL \state_mach|ALT_INV_floor_stop~DUPLICATE_q\ : std_logic;
SIGNAL \state_mach|ALT_INV_current_state.up~DUPLICATE_q\ : std_logic;
...
SIGNAL \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\ : std_logic;
...
SIGNAL \f_control|ALT_INV_i_floor_call_array_down~10_combout\ : std_logic;
...
SIGNAL \f_control|ALT_INV_i_floor_call_array_down~8_combout\ : std_logic;
...
SIGNAL \f_control|ALT_INV_i_floor_call_array_down~2_combout\ : std_logic;
...
SIGNAL \f_control|ALT_INV_i_floor_call_array_up~2_combout\ : std_logic;
...
\state_mach|ALT_INV_destination~DUPLICATE_q\ <= NOT \state_mach|destination~DUPLICATE_q\;
\state_mach|ALT_INV_floor_call~DUPLICATE_q\ <= NOT \state_mach|floor_call~DUPLICATE_q\;
\state_mach|ALT_INV_floor_stop~DUPLICATE_q\ <= NOT \state_mach|floor_stop~DUPLICATE_q\;
\state_mach|ALT_INV_current_state.up~DUPLICATE_q\ <= NOT \state_mach|current_state.up~DUPLICATE_q\;
...
\state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\ <= NOT \state_mach|i_current_floor[0]~DUPLICATE_q\;
...
\f_control|ALT_INV_i_floor_call_array_down~10_combout\ <= NOT \f_control|i_floor_call_array_down~10_combout\;
...
\f_control|ALT_INV_i_floor_call_array_down~8_combout\ <= NOT \f_control|i_floor_call_array_down~8_combout\;
...
\f_control|ALT_INV_i_floor_call_array_down~2_combout\ <= NOT \f_control|i_floor_call_array_down~2_combout\;
...
\f_control|ALT_INV_i_floor_call_array_up~2_combout\ <= NOT \f_control|i_floor_call_array_up~2_combout\;
...
-- Equation(s):
-- \count1|Add0~85_sumout\ = SUM(( \count1|i_count\(0) ) + ( VCC ) + ( !VCC ))
-- \count1|Add0~86\ = CARRY(( \count1|i_count\(0) ) + ( VCC ) + ( !VCC ))
...
-- Equation(s):
-- \count1|Add0~77_sumout\ = SUM(( \count1|i_count\(1) ) + ( GND ) + ( \count1|Add0~86\ ))
-- \count1|Add0~78\ = CARRY(( \count1|i_count\(1) ) + ( GND ) + ( \count1|Add0~86\ ))
...
-- Equation(s):
-- \count1|Add0~81_sumout\ = SUM(( \count1|i_count\(2) ) + ( GND ) + ( \count1|Add0~78\ ))
-- \count1|Add0~82\ = CARRY(( \count1|i_count\(2) ) + ( GND ) + ( \count1|Add0~78\ ))
...
-- Equation(s):
-- \count1|Add0~69_sumout\ = SUM(( \count1|i_count\(3) ) + ( GND ) + ( \count1|Add0~82\ ))
-- \count1|Add0~70\ = CARRY(( \count1|i_count\(3) ) + ( GND ) + ( \count1|Add0~82\ ))
...
-- Equation(s):
-- \count1|Add0~57_sumout\ = SUM(( \count1|i_count\(4) ) + ( GND ) + ( \count1|Add0~70\ ))
-- \count1|Add0~58\ = CARRY(( \count1|i_count\(4) ) + ( GND ) + ( \count1|Add0~70\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \count1|ALT_INV_i_count\(4),
	cin => \count1|Add0~70\,
...
-- Equation(s):
-- \count1|Add0~89_sumout\ = SUM(( \count1|i_count\(5) ) + ( GND ) + ( \count1|Add0~58\ ))
-- \count1|Add0~90\ = CARRY(( \count1|i_count\(5) ) + ( GND ) + ( \count1|Add0~58\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \count1|ALT_INV_i_count\(5),
	cin => \count1|Add0~58\,
...
-- Equation(s):
-- \count1|Add0~93_sumout\ = SUM(( \count1|i_count\(6) ) + ( GND ) + ( \count1|Add0~90\ ))
-- \count1|Add0~94\ = CARRY(( \count1|i_count\(6) ) + ( GND ) + ( \count1|Add0~90\ ))
...
-- Equation(s):
-- \count1|Add0~73_sumout\ = SUM(( \count1|i_count\(7) ) + ( GND ) + ( \count1|Add0~94\ ))
-- \count1|Add0~74\ = CARRY(( \count1|i_count\(7) ) + ( GND ) + ( \count1|Add0~94\ ))
...
-- Equation(s):
-- \count1|Add0~1_sumout\ = SUM(( \count1|i_count\(8) ) + ( GND ) + ( \count1|Add0~74\ ))
-- \count1|Add0~2\ = CARRY(( \count1|i_count\(8) ) + ( GND ) + ( \count1|Add0~74\ ))
...
-- Equation(s):
-- \count1|Add0~5_sumout\ = SUM(( \count1|i_count\(9) ) + ( GND ) + ( \count1|Add0~2\ ))
-- \count1|Add0~6\ = CARRY(( \count1|i_count\(9) ) + ( GND ) + ( \count1|Add0~2\ ))
...
-- Equation(s):
-- \count1|Add0~13_sumout\ = SUM(( \count1|i_count\(10) ) + ( GND ) + ( \count1|Add0~6\ ))
-- \count1|Add0~14\ = CARRY(( \count1|i_count\(10) ) + ( GND ) + ( \count1|Add0~6\ ))
...
-- Equation(s):
-- \count1|Add0~9_sumout\ = SUM(( \count1|i_count\(11) ) + ( GND ) + ( \count1|Add0~14\ ))
-- \count1|Add0~10\ = CARRY(( \count1|i_count\(11) ) + ( GND ) + ( \count1|Add0~14\ ))
...
-- Equation(s):
-- \count1|Add0~17_sumout\ = SUM(( \count1|i_count\(12) ) + ( GND ) + ( \count1|Add0~10\ ))
-- \count1|Add0~18\ = CARRY(( \count1|i_count\(12) ) + ( GND ) + ( \count1|Add0~10\ ))
...
-- Equation(s):
-- \count1|Add0~21_sumout\ = SUM(( \count1|i_count\(13) ) + ( GND ) + ( \count1|Add0~18\ ))
-- \count1|Add0~22\ = CARRY(( \count1|i_count\(13) ) + ( GND ) + ( \count1|Add0~18\ ))
...
-- Equation(s):
-- \count1|Add0~25_sumout\ = SUM(( \count1|i_count\(14) ) + ( GND ) + ( \count1|Add0~22\ ))
-- \count1|Add0~26\ = CARRY(( \count1|i_count\(14) ) + ( GND ) + ( \count1|Add0~22\ ))
...
-- Equation(s):
-- \count1|Add0~29_sumout\ = SUM(( \count1|i_count\(15) ) + ( GND ) + ( \count1|Add0~26\ ))
-- \count1|Add0~30\ = CARRY(( \count1|i_count\(15) ) + ( GND ) + ( \count1|Add0~26\ ))
...
-- Equation(s):
-- \count1|Add0~37_sumout\ = SUM(( \count1|i_count\(16) ) + ( GND ) + ( \count1|Add0~30\ ))
-- \count1|Add0~38\ = CARRY(( \count1|i_count\(16) ) + ( GND ) + ( \count1|Add0~30\ ))
...
-- Equation(s):
-- \count1|Add0~33_sumout\ = SUM(( \count1|i_count\(17) ) + ( GND ) + ( \count1|Add0~38\ ))
-- \count1|Add0~34\ = CARRY(( \count1|i_count\(17) ) + ( GND ) + ( \count1|Add0~38\ ))
...
-- Equation(s):
-- \count1|Equal0~1_combout\ = ( \count1|i_count\(13) & ( \count1|i_count\(15) & ( (!\count1|i_count\(16) & (\count1|i_count\(12) & (\count1|i_count\(17) & \count1|i_count\(14)))) ) ) )
...
-- Equation(s):
-- \count1|Add0~41_sumout\ = SUM(( \count1|i_count\(18) ) + ( GND ) + ( \count1|Add0~34\ ))
-- \count1|Add0~42\ = CARRY(( \count1|i_count\(18) ) + ( GND ) + ( \count1|Add0~34\ ))
...
-- Equation(s):
-- \count1|Add0~61_sumout\ = SUM(( \count1|i_count\(22) ) + ( GND ) + ( \count1|Add0~54\ ))
-- \count1|Add0~62\ = CARRY(( \count1|i_count\(22) ) + ( GND ) + ( \count1|Add0~54\ ))
...
-- Equation(s):
-- \count1|Add0~101_sumout\ = SUM(( \count1|i_count\(23) ) + ( GND ) + ( \count1|Add0~62\ ))
-- \count1|Add0~102\ = CARRY(( \count1|i_count\(23) ) + ( GND ) + ( \count1|Add0~62\ ))
...
-- Equation(s):
-- \count1|Add0~97_sumout\ = SUM(( \count1|i_count\(24) ) + ( GND ) + ( \count1|Add0~102\ ))
-- \count1|Add0~98\ = CARRY(( \count1|i_count\(24) ) + ( GND ) + ( \count1|Add0~102\ ))
...
-- Equation(s):
-- \count1|Add0~109_sumout\ = SUM(( \count1|i_count\(25) ) + ( GND ) + ( \count1|Add0~98\ ))
-- \count1|Add0~110\ = CARRY(( \count1|i_count\(25) ) + ( GND ) + ( \count1|Add0~98\ ))
...
-- Equation(s):
-- \count1|Add0~105_sumout\ = SUM(( \count1|i_count\(26) ) + ( GND ) + ( \count1|Add0~110\ ))
-- \count1|Add0~106\ = CARRY(( \count1|i_count\(26) ) + ( GND ) + ( \count1|Add0~110\ ))
...
-- Equation(s):
-- \count1|Equal0~4_combout\ = ( \count1|i_count\(25) & ( \count1|i_count\(23) & ( (!\count1|i_count\(26) & (!\count1|i_count\(6) & !\count1|i_count\(24))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \count1|ALT_INV_i_count\(26),
	datac => \count1|ALT_INV_i_count\(6),
...
-- Equation(s):
-- \count1|Equal0~0_combout\ = ( !\count1|i_count\(8) & ( (!\count1|i_count\(10) & (!\count1|i_count\(9) & !\count1|i_count\(11))) ) )
...
-- Equation(s):
-- \count1|Add0~65_sumout\ = SUM(( \count1|i_count\(27) ) + ( GND ) + ( \count1|Add0~106\ ))
...
-- Equation(s):
-- \count1|Equal0~3_combout\ = ( !\count1|i_count\(27) & ( \count1|i_count\(7) & ( (!\count1|i_count\(1) & (!\count1|i_count\(3) & (!\count1|i_count\(2) & !\count1|i_count\(0)))) ) ) )
...
PORT MAP (
	...
	dataf => \count1|ALT_INV_i_count\(7),
	combout => \count1|Equal0~3_combout\);

-- Location: LABCELL_X63_Y3_N24
\count1|Equal0~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \count1|Equal0~2_combout\ = ( \count1|i_count\(19) & ( \count1|i_count\(22) & ( (!\count1|i_count\(18) & (\count1|i_count\(21) & (\count1|i_count\(20) & !\count1|i_count\(4)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \count1|ALT_INV_i_count\(18),
	datab => \count1|ALT_INV_i_count\(21),
	datac => \count1|ALT_INV_i_count\(20),
	datad => \count1|ALT_INV_i_count\(4),
	datae => \count1|ALT_INV_i_count\(19),
	dataf => \count1|ALT_INV_i_count\(22),
	combout => \count1|Equal0~2_combout\);

-- Location: LABCELL_X63_Y3_N9
\rtl~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \rtl~0_combout\ = LCELL(( \count1|Equal0~3_combout\ & ( \count1|Equal0~2_combout\ & ( (\count1|Equal0~1_combout\ & (!\count1|i_count\(5) & (\count1|Equal0~4_combout\ & \count1|Equal0~0_combout\))) ) ) ))
...
-- Equation(s):
-- \state_mach|i_current_floor[0]~4_combout\ = ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|Decoder0~6_combout\ = ( \SW[2]~input_o\ & ( (\SW[1]~input_o\ & !\SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~2_combout\ = ( !\SW[4]~input_o\ & ( (!\KEY~input_o\ & \SW[3]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder0~4_combout\ = ( !\SW[0]~input_o\ & ( (\SW[2]~input_o\ & !\SW[1]~input_o\) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~2_combout\ = ( !\KEY~input_o\ & ( (!\SW[3]~input_o\ & !\SW[4]~input_o\) ) )
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \state_mach|destination~7_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|Selector1~0_combout\ = ( !\state_mach|floor_stop~q\ & ( ((\state_mach|current_state.loading~q\ & (\state_mach|destination~q\ & !\state_mach|i_direction~q\))) # (\state_mach|current_state.up~q\) ) )
...
-- Equation(s):
-- \state_mach|Selector1~1_combout\ = ( \state_mach|Selector1~0_combout\ ) # ( !\state_mach|Selector1~0_combout\ & ( (!\state_mach|i_direction~q\ & \state_mach|Selector2~0_combout\) ) )
...
PORT MAP (
	...
	datad => \state_mach|ALT_INV_Selector2~0_combout\,
...
-- Equation(s):
-- \state_mach|Selector3~0_combout\ = ( \state_mach|floor_stop~q\ & ( \state_mach|current_state.up~q\ ) ) # ( \state_mach|floor_stop~q\ & ( !\state_mach|current_state.up~q\ & ( ((!\state_mach|destination~q\ & (!\state_mach|current_state.idle~DUPLICATE_q\ & 
-- \state_mach|floor_call~DUPLICATE_q\))) # (\state_mach|current_state.down~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010101011101010100000000000000001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \state_mach|ALT_INV_floor_call~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|Selector2~1_combout\ = ( \state_mach|i_direction~q\ & ( (!\state_mach|current_state.down~q\ & ((!\state_mach|current_state.loading~q\) # (!\state_mach|destination~q\))) ) ) # ( !\state_mach|i_direction~q\ & ( !\state_mach|current_state.down~q\ 
-- ) )
...
-- Equation(s):
-- \state_mach|Selector2~2_combout\ = ( \state_mach|Selector2~1_combout\ & ( (\state_mach|Selector2~0_combout\ & \state_mach|i_direction~q\) ) ) # ( !\state_mach|Selector2~1_combout\ & ( (!\state_mach|floor_stop~DUPLICATE_q\) # 
-- ((\state_mach|Selector2~0_combout\ & \state_mach|i_direction~q\)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_floor_stop~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_Selector2~0_combout\,
	datad => \state_mach|ALT_INV_i_direction~q\,
	dataf => \state_mach|ALT_INV_Selector2~1_combout\,
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \state_mach|Selector2~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~0_combout\ = ( \state_mach|current_state.up~q\ & ( (\state_mach|current_state.idle~q\ & (!\state_mach|i_direction~q\ & !\state_mach|current_state.down~q\)) ) ) # ( !\state_mach|current_state.up~q\ & ( 
-- (\state_mach|current_state.idle~q\ & !\state_mach|i_direction~q\) ) )
...
-- Equation(s):
-- \f_control|Decoder0~7_combout\ = ( \SW[2]~input_o\ & ( (\SW[1]~input_o\ & \SW[0]~input_o\) ) )
...
-- Equation(s):
-- \state_mach|Add0~0_combout\ = ( \state_mach|i_current_floor\(0) & ( (\state_mach|i_current_floor\(1) & \state_mach|i_current_floor[2]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~10_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( \f_control|i_floor_call_array_down\(7) & ( !\state_mach|Add0~0_combout\ ) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( 
-- \f_control|i_floor_call_array_down\(7) ) ) # ( \f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|i_floor_call_array_down\(7) & ( (\f_control|Decoder0~7_combout\ & (!\state_mach|Add0~0_combout\ & \f_control|i_floor_call_array_down~2_combout\)) 
-- ) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|i_floor_call_array_down\(7) & ( (\f_control|Decoder0~7_combout\ & \f_control|i_floor_call_array_down~2_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000101000001000000010011111111111111111100110011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~7_combout\,
	datab => \state_mach|ALT_INV_Add0~0_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
...
\f_control|i_floor_call_array_down[7]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|i_floor_call_array_down[7]~feeder_combout\ = ( \f_control|i_floor_call_array_down~10_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \f_control|ALT_INV_i_floor_call_array_down~10_combout\,
	combout => \f_control|i_floor_call_array_down[7]~feeder_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \f_control|i_floor_call_array_down[7]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~9_combout\ = ( !\f_control|i_floor_call_array_down~1_combout\ & ( \f_control|Decoder1~7_combout\ & ( ((\f_control|Decoder0~6_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(6)) ) ) ) # ( \f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|Decoder1~7_combout\ & ( ((\f_control|Decoder0~6_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(6)) ) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|Decoder1~7_combout\ & ( ((\f_control|Decoder0~6_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(6)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011011100110111001101110011011100110111001101110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~6_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_down\(6),
	datac => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datae => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
...
-- Equation(s):
-- \f_control|Decoder0~5_combout\ = ( \SW[2]~input_o\ & ( (!\SW[1]~input_o\ & \SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder1~6_combout\ = ( !\state_mach|i_current_floor\(1) & ( (\state_mach|i_current_floor\(0) & \state_mach|i_current_floor\(2)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~8_combout\ = ( \f_control|i_floor_call_array_down\(5) & ( \f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|Decoder1~6_combout\ ) ) ) # ( !\f_control|i_floor_call_array_down\(5) & ( 
-- \f_control|i_floor_call_array_down~1_combout\ & ( (\f_control|i_floor_call_array_down~2_combout\ & (\f_control|Decoder0~5_combout\ & !\f_control|Decoder1~6_combout\)) ) ) ) # ( \f_control|i_floor_call_array_down\(5) & ( 
-- !\f_control|i_floor_call_array_down~1_combout\ ) ) # ( !\f_control|i_floor_call_array_down\(5) & ( !\f_control|i_floor_call_array_down~1_combout\ & ( (\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~5_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001111111111111111100010001000000001111111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datab => \f_control|ALT_INV_Decoder0~5_combout\,
	datad => \f_control|ALT_INV_Decoder1~6_combout\,
	datae => \f_control|ALT_INV_i_floor_call_array_down\(5),
	dataf => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
	combout => \f_control|i_floor_call_array_down~8_combout\);

-- Location: LABCELL_X64_Y3_N36
\f_control|i_floor_call_array_down[5]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|i_floor_call_array_down[5]~feeder_combout\ = ( \f_control|i_floor_call_array_down~8_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \f_control|ALT_INV_i_floor_call_array_down~8_combout\,
	combout => \f_control|i_floor_call_array_down[5]~feeder_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \f_control|i_floor_call_array_down[5]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|Mux2~0_combout\ = ( \f_control|i_floor_call_array_down\(4) & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & ((\f_control|i_floor_call_array_down\(5)))) # (\state_mach|i_current_floor\(1) & 
-- (\f_control|i_floor_call_array_down\(7))) ) ) ) # ( !\f_control|i_floor_call_array_down\(4) & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & ((\f_control|i_floor_call_array_down\(5)))) # (\state_mach|i_current_floor\(1) & 
-- (\f_control|i_floor_call_array_down\(7))) ) ) ) # ( \f_control|i_floor_call_array_down\(4) & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1)) # (\f_control|i_floor_call_array_down\(6)) ) ) ) # ( 
-- !\f_control|i_floor_call_array_down\(4) & ( !\state_mach|i_current_floor\(0) & ( (\f_control|i_floor_call_array_down\(6) & \state_mach|i_current_floor\(1)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down\(7),
	datab => \f_control|ALT_INV_i_floor_call_array_down\(6),
	datac => \f_control|ALT_INV_i_floor_call_array_down\(5),
...
-- Equation(s):
-- \f_control|Decoder0~2_combout\ = ( !\SW[2]~input_o\ & ( (\SW[1]~input_o\ & !\SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder1~3_combout\ = ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & \state_mach|i_current_floor\(1)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~5_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( (!\f_control|Decoder1~3_combout\ & (((\f_control|Decoder0~2_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(2)))) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|Decoder0~2_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(2)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~2_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datac => \f_control|ALT_INV_Decoder1~3_combout\,
...
-- Equation(s):
-- \f_control|Decoder0~1_combout\ = ( !\SW[0]~input_o\ & ( (!\SW[2]~input_o\ & !\SW[1]~input_o\) ) )
...
-- Equation(s):
-- \state_mach|Add1~0_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\state_mach|i_current_floor[2]~DUPLICATE_q\) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~4_combout\ = ( \state_mach|Add1~0_combout\ & ( (!\f_control|i_floor_call_array_down~1_combout\ & (((\f_control|Decoder0~1_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(0)))) ) ) # ( !\state_mach|Add1~0_combout\ & ( ((\f_control|Decoder0~1_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(0)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101011101010111010101110101011101010111000000000101011100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down\(0),
	datab => \f_control|ALT_INV_Decoder0~1_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datad => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
	dataf => \state_mach|ALT_INV_Add1~0_combout\,
...
-- Equation(s):
-- \f_control|Decoder0~3_combout\ = ( !\SW[2]~input_o\ & ( (\SW[1]~input_o\ & \SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder1~4_combout\ = ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(2) & \state_mach|i_current_floor\(1)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~6_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( (!\f_control|Decoder1~4_combout\ & (((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(3)))) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(3)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001101110111001100000111000000110011011101110011000001110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~3_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_down\(3),
	datac => \f_control|ALT_INV_Decoder1~4_combout\,
	datad => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datae => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
...
-- Equation(s):
-- \f_control|Decoder0~0_combout\ = ( \SW[0]~input_o\ & ( (!\SW[2]~input_o\ & !\SW[1]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder1~2_combout\ = ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor\(1)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~3_combout\ = ( \f_control|Decoder1~2_combout\ & ( (!\f_control|i_floor_call_array_down~1_combout\ & (((\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~0_combout\)) # 
-- (\f_control|i_floor_call_array_down\(1)))) ) ) # ( !\f_control|Decoder1~2_combout\ & ( ((\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~0_combout\)) # (\f_control|i_floor_call_array_down\(1)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001111100011111000111110001111100011111000000000001111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	...
	datad => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
	dataf => \f_control|ALT_INV_Decoder1~2_combout\,
...
-- Equation(s):
-- \state_mach|Mux2~1_combout\ = ( \state_mach|i_current_floor\(1) & ( \f_control|i_floor_call_array_down\(1) & ( (!\state_mach|i_current_floor\(0) & (\f_control|i_floor_call_array_down\(2))) # (\state_mach|i_current_floor\(0) & 
-- ((\f_control|i_floor_call_array_down\(3)))) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( \f_control|i_floor_call_array_down\(1) & ( (\f_control|i_floor_call_array_down\(0)) # (\state_mach|i_current_floor\(0)) ) ) ) # ( \state_mach|i_current_floor\(1) & 
-- ( !\f_control|i_floor_call_array_down\(1) & ( (!\state_mach|i_current_floor\(0) & (\f_control|i_floor_call_array_down\(2))) # (\state_mach|i_current_floor\(0) & ((\f_control|i_floor_call_array_down\(3)))) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( 
-- !\f_control|i_floor_call_array_down\(1) & ( (!\state_mach|i_current_floor\(0) & \f_control|i_floor_call_array_down\(0)) ) ) )
...
PORT MAP (
	...
	datab => \f_control|ALT_INV_i_floor_call_array_down\(2),
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~1_combout\ = ( \state_mach|Mux2~1_combout\ & ( (!\f_control|i_floor_call_array_down~0_combout\ & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (\state_mach|Mux2~0_combout\))) ) ) # ( !\state_mach|Mux2~1_combout\ & ( 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\f_control|i_floor_call_array_down~0_combout\ & \state_mach|Mux2~0_combout\)) ) )
...
PORT MAP (
	...
	datac => \state_mach|ALT_INV_Mux2~0_combout\,
	dataf => \state_mach|ALT_INV_Mux2~1_combout\,
	combout => \f_control|i_floor_call_array_down~1_combout\);

-- Location: LABCELL_X62_Y4_N51
\f_control|Decoder1~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|Decoder1~0_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ ) )
...
-- pragma translate_on
PORT MAP (
	datac => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	dataf => \state_mach|ALT_INV_i_current_floor[1]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|Decoder1~5_combout\ = ( \f_control|Decoder1~0_combout\ & ( \state_mach|i_current_floor\(2) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~7_combout\ = ( !\f_control|i_floor_call_array_down~1_combout\ & ( \f_control|Decoder1~5_combout\ & ( ((\f_control|Decoder0~4_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(4)) ) ) ) # ( \f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|Decoder1~5_combout\ & ( ((\f_control|Decoder0~4_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(4)) ) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( !\f_control|Decoder1~5_combout\ & ( ((\f_control|Decoder0~4_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010111111111000001011111111100000101111111110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
	dataf => \f_control|ALT_INV_Decoder1~5_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~0_combout\ = ( \state_mach|current_state.up~q\ & ( (\state_mach|current_state.idle~q\ & (\state_mach|i_direction~q\ & !\state_mach|current_state.down~q\)) ) ) # ( !\state_mach|current_state.up~q\ & ( 
-- (\state_mach|current_state.idle~q\ & \state_mach|i_direction~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000101000001010000010100000101000000000000010100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~q\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~3_combout\ = ( \f_control|i_floor_call_array_up\(1) & ( \f_control|i_floor_call_array_up~1_combout\ & ( !\f_control|Decoder1~2_combout\ ) ) ) # ( !\f_control|i_floor_call_array_up\(1) & ( 
-- \f_control|i_floor_call_array_up~1_combout\ & ( (\f_control|i_floor_call_array_up~2_combout\ & (\f_control|Decoder0~0_combout\ & !\f_control|Decoder1~2_combout\)) ) ) ) # ( \f_control|i_floor_call_array_up\(1) & ( 
-- !\f_control|i_floor_call_array_up~1_combout\ ) ) # ( !\f_control|i_floor_call_array_up\(1) & ( !\f_control|i_floor_call_array_up~1_combout\ & ( (\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~0_combout\) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	datab => \f_control|ALT_INV_Decoder0~0_combout\,
	datac => \f_control|ALT_INV_Decoder1~2_combout\,
	datae => \f_control|ALT_INV_i_floor_call_array_up\(1),
	dataf => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~4_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( (!\state_mach|Add1~0_combout\ & (((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~1_combout\)) # (\f_control|i_floor_call_array_up\(0)))) ) 
-- ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~1_combout\)) # (\f_control|i_floor_call_array_up\(0)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~5_combout\ = ( \f_control|Decoder1~3_combout\ & ( (!\f_control|i_floor_call_array_up~1_combout\ & (((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~2_combout\)) # (\f_control|i_floor_call_array_up\(2)))) 
-- ) ) # ( !\f_control|Decoder1~3_combout\ & ( ((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~2_combout\)) # (\f_control|i_floor_call_array_up\(2)) ) )
...
PORT MAP (
	...
	datab => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~6_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( (!\f_control|Decoder1~4_combout\ & (((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(3)))) 
-- ) ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(3)) ) )
...
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~3_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_up\(3),
	datad => \f_control|ALT_INV_Decoder1~4_combout\,
	dataf => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
...
-- Equation(s):
-- \state_mach|Mux1~1_combout\ = ( \f_control|i_floor_call_array_up\(3) & ( \state_mach|i_current_floor\(0) & ( (\state_mach|i_current_floor\(1)) # (\f_control|i_floor_call_array_up\(1)) ) ) ) # ( !\f_control|i_floor_call_array_up\(3) & ( 
-- \state_mach|i_current_floor\(0) & ( (\f_control|i_floor_call_array_up\(1) & !\state_mach|i_current_floor\(1)) ) ) ) # ( \f_control|i_floor_call_array_up\(3) & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & 
-- (\f_control|i_floor_call_array_up\(0))) # (\state_mach|i_current_floor\(1) & ((\f_control|i_floor_call_array_up\(2)))) ) ) ) # ( !\f_control|i_floor_call_array_up\(3) & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & 
-- (\f_control|i_floor_call_array_up\(0))) # (\state_mach|i_current_floor\(1) & ((\f_control|i_floor_call_array_up\(2)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(1),
	datab => \f_control|ALT_INV_i_floor_call_array_up\(0),
	datac => \state_mach|ALT_INV_i_current_floor\(1),
	datad => \f_control|ALT_INV_i_floor_call_array_up\(2),
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~1_combout\ = ( \state_mach|Mux1~0_combout\ & ( (!\f_control|i_floor_call_array_up~0_combout\ & ((\state_mach|Mux1~1_combout\) # (\state_mach|i_current_floor\(2)))) ) ) # ( !\state_mach|Mux1~0_combout\ & ( 
-- (!\state_mach|i_current_floor\(2) & (!\f_control|i_floor_call_array_up~0_combout\ & \state_mach|Mux1~1_combout\)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~7_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( (!\f_control|Decoder1~5_combout\ & (((\f_control|Decoder0~4_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(4)))) 
-- ) ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~4_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(4)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001101110111001100110111011100110000011100000011000001110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~4_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_up\(4),
	datac => \f_control|ALT_INV_Decoder1~5_combout\,
	datad => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	dataf => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~1_combout\ = ( !\f_control|i_floor_call_array_down\(3) & ( !\f_control|i_floor_call_array_up\(3) ) )
...
PORT MAP (
	datac => \f_control|ALT_INV_i_floor_call_array_up\(3),
	dataf => \f_control|ALT_INV_i_floor_call_array_down\(3),
...
-- Equation(s):
-- \state_mach|check_destination_bits~0_combout\ = ( \f_control|i_floor_call_array_down\(0) & ( \f_control|i_floor_call_array_up\(1) ) ) # ( !\f_control|i_floor_call_array_down\(0) & ( \f_control|i_floor_call_array_up\(1) ) ) # ( 
-- \f_control|i_floor_call_array_down\(0) & ( !\f_control|i_floor_call_array_up\(1) ) ) # ( !\f_control|i_floor_call_array_down\(0) & ( !\f_control|i_floor_call_array_up\(1) & ( (((\f_control|i_floor_call_array_up\(0)) # 
-- (\f_control|i_floor_call_array_down\(1))) # (\f_control|i_floor_call_array_down\(2))) # (\f_control|i_floor_call_array_up\(2)) ) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~8_combout\ = ( \f_control|i_floor_call_array_up\(5) & ( (!\f_control|i_floor_call_array_up~1_combout\) # (!\f_control|Decoder1~6_combout\) ) ) # ( !\f_control|i_floor_call_array_up\(5) & ( 
-- (\f_control|i_floor_call_array_up~2_combout\ & (\f_control|Decoder0~5_combout\ & ((!\f_control|i_floor_call_array_up~1_combout\) # (!\f_control|Decoder1~6_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001100000010000000110000001011111111101010101111111110101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~5_combout\ = ( \state_mach|check_destination_bits~0_combout\ & ( \state_mach|check_destination_bits~3_combout\ ) ) # ( !\state_mach|check_destination_bits~0_combout\ & ( \state_mach|check_destination_bits~3_combout\ & ( 
-- (!\state_mach|check_destination_bits~2_combout\) # ((!\state_mach|check_destination_bits~4_combout\) # (!\state_mach|check_destination_bits~1_combout\)) ) ) ) # ( \state_mach|check_destination_bits~0_combout\ & ( 
-- !\state_mach|check_destination_bits~3_combout\ ) ) # ( !\state_mach|check_destination_bits~0_combout\ & ( !\state_mach|check_destination_bits~3_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111111111111111111111111111111001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_check_destination_bits~2_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~4_combout\,
	datad => \state_mach|ALT_INV_check_destination_bits~1_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~0_combout\,
	dataf => \state_mach|ALT_INV_check_destination_bits~3_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~10_combout\ = ( \f_control|i_floor_call_array_up\(7) & ( (!\f_control|i_floor_call_array_up~1_combout\) # (!\state_mach|Add0~0_combout\) ) ) # ( !\f_control|i_floor_call_array_up\(7) & ( 
-- (\f_control|i_floor_call_array_up~2_combout\ & (\f_control|Decoder0~7_combout\ & ((!\f_control|i_floor_call_array_up~1_combout\) # (!\state_mach|Add0~0_combout\)))) ) )
...
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	datac => \f_control|ALT_INV_Decoder0~7_combout\,
	datad => \state_mach|ALT_INV_Add0~0_combout\,
...
PORT MAP (
	clk => \rtl~0_combout\,
	asdata => \f_control|i_floor_call_array_up~10_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|check_destination_bits~21_combout\ = ( \f_control|i_floor_call_array_down\(7) ) # ( !\f_control|i_floor_call_array_down\(7) & ( \f_control|i_floor_call_array_up\(7) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~22_combout\ = ( \state_mach|check_destination_bits~21_combout\ ) # ( !\state_mach|check_destination_bits~21_combout\ & ( \state_mach|check_destination_bits~5_combout\ ) )
...
PORT MAP (
	...
	dataf => \state_mach|ALT_INV_check_destination_bits~21_combout\,
	combout => \state_mach|check_destination_bits~22_combout\);

-- Location: FF_X62_Y5_N4
\state_mach|floor_call~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \state_mach|check_destination_bits~22_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \state_mach|floor_call~DUPLICATE_q\);

-- Location: LABCELL_X62_Y5_N54
\state_mach|Selector2~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|Selector2~0_combout\ = ( \state_mach|floor_call~DUPLICATE_q\ & ( (!\state_mach|current_state.idle~DUPLICATE_q\ & !\state_mach|floor_stop~DUPLICATE_q\) ) ) # ( !\state_mach|floor_call~DUPLICATE_q\ & ( 
-- (!\state_mach|current_state.idle~DUPLICATE_q\ & (!\state_mach|floor_stop~DUPLICATE_q\ & \state_mach|destination~DUPLICATE_q\)) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_current_state.idle~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_floor_stop~DUPLICATE_q\,
	datad => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	dataf => \state_mach|ALT_INV_floor_call~DUPLICATE_q\,
	combout => \state_mach|Selector2~0_combout\);

-- Location: LABCELL_X62_Y5_N30
\state_mach|i_current_floor~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_current_floor~1_combout\ = ( \state_mach|Selector1~0_combout\ & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\state_mach|i_current_floor[1]~DUPLICATE_q\) ) ) # ( !\state_mach|Selector1~0_combout\ & ( 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\state_mach|i_current_floor[1]~DUPLICATE_q\ $ (((!\state_mach|Selector2~0_combout\) # (\state_mach|i_direction~q\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1001011010011001100101101001100101100110011001100110011001100110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|Decoder1~1_combout\ = ( \state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \f_control|Decoder1~7_combout\ = ( \f_control|Decoder1~1_combout\ & ( !\state_mach|i_current_floor\(0) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~9_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( (!\f_control|Decoder1~7_combout\ & (((\f_control|Decoder0~6_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(6)))) 
-- ) ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~6_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(6)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(6),
	datab => \f_control|ALT_INV_Decoder0~6_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
...
-- Equation(s):
-- \state_mach|Mux1~0_combout\ = ( \f_control|i_floor_call_array_up\(5) & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1)) # (\f_control|i_floor_call_array_up\(7)) ) ) ) # ( !\f_control|i_floor_call_array_up\(5) & ( 
-- \state_mach|i_current_floor\(0) & ( (\state_mach|i_current_floor\(1) & \f_control|i_floor_call_array_up\(7)) ) ) ) # ( \f_control|i_floor_call_array_up\(5) & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & 
-- ((\f_control|i_floor_call_array_up\(4)))) # (\state_mach|i_current_floor\(1) & (\f_control|i_floor_call_array_up\(6))) ) ) ) # ( !\f_control|i_floor_call_array_up\(5) & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & 
-- ((\f_control|i_floor_call_array_up\(4)))) # (\state_mach|i_current_floor\(1) & (\f_control|i_floor_call_array_up\(6))) ) ) )
...
-- Equation(s):
-- \state_mach|Mux1~2_combout\ = ( \state_mach|Mux1~1_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (\state_mach|Mux1~0_combout\) ) ) # ( !\state_mach|Mux1~1_combout\ & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- \state_mach|Mux1~0_combout\) ) )
...
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_Mux1~0_combout\,
	dataf => \state_mach|ALT_INV_Mux1~1_combout\,
	combout => \state_mach|Mux1~2_combout\);

-- Location: LABCELL_X62_Y3_N15
\f_control|i_destination_array~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|i_destination_array~6_combout\ = ( !\KEY~input_o\ & ( (\SW[1]~input_o\ & (\SW[0]~input_o\ & (!\SW[2]~input_o\ & \SW[4]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~8_combout\ = ( !\KEY~input_o\ & ( (!\SW[1]~input_o\ & (!\SW[0]~input_o\ & (\SW[2]~input_o\ & \SW[4]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~9_combout\ = ( \f_control|i_destination_array\(4) & ( \state_mach|Mux0~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (!\f_control|Decoder1~0_combout\) ) ) ) # ( !\f_control|i_destination_array\(4) & ( 
-- \state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~8_combout\ & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (!\f_control|Decoder1~0_combout\))) ) ) ) # ( \f_control|i_destination_array\(4) & ( !\state_mach|Mux0~0_combout\ ) ) # ( 
-- !\f_control|i_destination_array\(4) & ( !\state_mach|Mux0~0_combout\ & ( \f_control|i_destination_array~8_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010101111111111111111101010100010101001111110011111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~8_combout\,
...
\f_control|i_destination_array[4]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|i_destination_array[4]~feeder_combout\ = ( \f_control|i_destination_array~9_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \f_control|ALT_INV_i_destination_array~9_combout\,
	combout => \f_control|i_destination_array[4]~feeder_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \f_control|i_destination_array[4]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_destination_array~14_combout\ = ( !\KEY~input_o\ & ( (\SW[1]~input_o\ & (\SW[0]~input_o\ & (\SW[4]~input_o\ & \SW[2]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~15_combout\ = ( \state_mach|Add0~0_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\state_mach|Mux0~1_combout\ & (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((\f_control|i_destination_array~14_combout\) # 
-- (\f_control|i_destination_array\(7))))) ) ) ) # ( !\state_mach|Add0~0_combout\ & ( \state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~14_combout\) # (\f_control|i_destination_array\(7)) ) ) ) # ( \state_mach|Add0~0_combout\ & ( 
-- !\state_mach|Mux0~0_combout\ & ( (!\state_mach|Mux0~1_combout\ & (((\f_control|i_destination_array~14_combout\) # (\f_control|i_destination_array\(7))))) # (\state_mach|Mux0~1_combout\ & (\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- ((\f_control|i_destination_array~14_combout\) # (\f_control|i_destination_array\(7))))) ) ) ) # ( !\state_mach|Add0~0_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~14_combout\) # (\f_control|i_destination_array\(7)) ) ) )
...
PORT MAP (
	...
	datad => \f_control|ALT_INV_i_destination_array~14_combout\,
	datae => \state_mach|ALT_INV_Add0~0_combout\,
	dataf => \state_mach|ALT_INV_Mux0~0_combout\,
	combout => \f_control|i_destination_array~15_combout\);

-- Location: LABCELL_X62_Y6_N24
\f_control|i_destination_array[7]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \f_control|i_destination_array[7]~feeder_combout\ = ( \f_control|i_destination_array~15_combout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \f_control|ALT_INV_i_destination_array~15_combout\,
	combout => \f_control|i_destination_array[7]~feeder_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \f_control|i_destination_array[7]~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_destination_array~10_combout\ = ( !\KEY~input_o\ & ( (!\SW[1]~input_o\ & (\SW[0]~input_o\ & (\SW[2]~input_o\ & \SW[4]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~11_combout\ = ( \f_control|Decoder1~6_combout\ & ( \state_mach|Mux0~1_combout\ & ( (!\state_mach|Mux0~0_combout\ & (\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((\f_control|i_destination_array\(5)) # 
-- (\f_control|i_destination_array~10_combout\)))) ) ) ) # ( !\f_control|Decoder1~6_combout\ & ( \state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(5)) # (\f_control|i_destination_array~10_combout\) ) ) ) # ( \f_control|Decoder1~6_combout\ & ( 
-- !\state_mach|Mux0~1_combout\ & ( (!\f_control|i_destination_array~10_combout\ & (\f_control|i_destination_array\(5) & ((!\state_mach|Mux0~0_combout\) # (!\state_mach|i_current_floor[2]~DUPLICATE_q\)))) # (\f_control|i_destination_array~10_combout\ & 
-- (((!\state_mach|Mux0~0_combout\) # (!\state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) ) # ( !\f_control|Decoder1~6_combout\ & ( !\state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(5)) # (\f_control|i_destination_array~10_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011101110111011101110111000001110111011101110000000001110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~10_combout\,
	datab => \f_control|ALT_INV_i_destination_array\(5),
	datac => \state_mach|ALT_INV_Mux0~0_combout\,
	datad => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	datae => \f_control|ALT_INV_Decoder1~6_combout\,
...
-- Equation(s):
-- \state_mach|Mux0~0_combout\ = ( \state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(0) & ( \f_control|i_destination_array\(7) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(0) & ( 
-- \f_control|i_destination_array\(5) ) ) ) # ( \state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor\(0) & ( \f_control|i_destination_array\(6) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor\(0) & ( 
...
-- Equation(s):
-- \f_control|i_destination_array~7_combout\ = ( \f_control|i_destination_array\(3) & ( \state_mach|Mux0~1_combout\ & ( (!\f_control|Decoder1~4_combout\) # ((!\state_mach|Mux0~0_combout\ & \state_mach|i_current_floor[2]~DUPLICATE_q\)) ) ) ) # ( 
-- !\f_control|i_destination_array\(3) & ( \state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array~6_combout\ & ((!\f_control|Decoder1~4_combout\) # ((!\state_mach|Mux0~0_combout\ & \state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) ) # ( 
-- \f_control|i_destination_array\(3) & ( !\state_mach|Mux0~1_combout\ & ( (!\state_mach|Mux0~0_combout\) # ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (!\f_control|Decoder1~4_combout\)) ) ) ) # ( !\f_control|i_destination_array\(3) & ( 
-- !\state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array~6_combout\ & ((!\state_mach|Mux0~0_combout\) # ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (!\f_control|Decoder1~4_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010100111111111111110001010101000001001111111100001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~6_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~0_combout\ = ( !\KEY~input_o\ & ( (!\SW[1]~input_o\ & (!\SW[0]~input_o\ & (\SW[4]~input_o\ & !\SW[2]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~1_combout\ = ( \f_control|Decoder1~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\state_mach|Mux0~1_combout\ & ((\f_control|i_destination_array\(0)) # (\f_control|i_destination_array~0_combout\)))) # 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\f_control|i_destination_array\(0))) # (\f_control|i_destination_array~0_combout\))) ) ) # ( !\f_control|Decoder1~0_combout\ & ( (\f_control|i_destination_array\(0)) # 
-- (\f_control|i_destination_array~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011111100111111001111110011111100111111000101010011111100010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	...
	datad => \state_mach|ALT_INV_Mux0~1_combout\,
	dataf => \f_control|ALT_INV_Decoder1~0_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~2_combout\ = ( !\KEY~input_o\ & ( (!\SW[1]~input_o\ & (\SW[0]~input_o\ & (\SW[4]~input_o\ & !\SW[2]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~3_combout\ = ( \f_control|Decoder1~2_combout\ & ( \state_mach|Mux0~1_combout\ & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\state_mach|Mux0~0_combout\ & ((\f_control|i_destination_array~2_combout\) # 
-- (\f_control|i_destination_array\(1))))) ) ) ) # ( !\f_control|Decoder1~2_combout\ & ( \state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array~2_combout\) # (\f_control|i_destination_array\(1)) ) ) ) # ( \f_control|Decoder1~2_combout\ & ( 
-- !\state_mach|Mux0~1_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\f_control|i_destination_array~2_combout\) # (\f_control|i_destination_array\(1))))) # (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\state_mach|Mux0~0_combout\ & 
-- ((\f_control|i_destination_array~2_combout\) # (\f_control|i_destination_array\(1))))) ) ) ) # ( !\f_control|Decoder1~2_combout\ & ( !\state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array~2_combout\) # (\f_control|i_destination_array\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111111111111000011101110111000001111111111110000010001000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|i_destination_array~4_combout\ = ( !\KEY~input_o\ & ( (\SW[1]~input_o\ & (!\SW[0]~input_o\ & (!\SW[2]~input_o\ & \SW[4]~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~5_combout\ = ( \f_control|Decoder1~3_combout\ & ( \state_mach|Mux0~1_combout\ & ( (!\state_mach|Mux0~0_combout\ & (\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((\f_control|i_destination_array\(2)) # 
-- (\f_control|i_destination_array~4_combout\)))) ) ) ) # ( !\f_control|Decoder1~3_combout\ & ( \state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(2)) # (\f_control|i_destination_array~4_combout\) ) ) ) # ( \f_control|Decoder1~3_combout\ & ( 
-- !\state_mach|Mux0~1_combout\ & ( (!\f_control|i_destination_array~4_combout\ & (\f_control|i_destination_array\(2) & ((!\state_mach|Mux0~0_combout\) # (!\state_mach|i_current_floor[2]~DUPLICATE_q\)))) # (\f_control|i_destination_array~4_combout\ & 
-- ((!\state_mach|Mux0~0_combout\) # ((!\state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) ) # ( !\f_control|Decoder1~3_combout\ & ( !\state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(2)) # (\f_control|i_destination_array~4_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101111101011111010111110100110001011111010111110000000001001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~4_combout\,
	datab => \state_mach|ALT_INV_Mux0~0_combout\,
	datac => \f_control|ALT_INV_i_destination_array\(2),
	datad => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	datae => \f_control|ALT_INV_Decoder1~3_combout\,
	dataf => \state_mach|ALT_INV_Mux0~1_combout\,
...
-- Equation(s):
-- \state_mach|Mux0~1_combout\ = ( \state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(0) & ( \f_control|i_destination_array\(3) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(0) & ( 
-- \f_control|i_destination_array\(1) ) ) ) # ( \state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor\(0) & ( \f_control|i_destination_array\(2) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor\(0) & ( 
...
-- Equation(s):
-- \state_mach|Mux0~2_combout\ = ( \state_mach|Mux0~0_combout\ & ( (\state_mach|Mux0~1_combout\) # (\state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) # ( !\state_mach|Mux0~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- \state_mach|Mux0~1_combout\) ) )
...
-- Equation(s):
-- \state_mach|Mux2~2_combout\ = ( \state_mach|Mux2~1_combout\ & ( (!\state_mach|i_current_floor\(2)) # (\state_mach|Mux2~0_combout\) ) ) # ( !\state_mach|Mux2~1_combout\ & ( (\state_mach|i_current_floor\(2) & \state_mach|Mux2~0_combout\) ) )
...
PORT MAP (
	...
	datad => \state_mach|ALT_INV_Mux2~0_combout\,
	dataf => \state_mach|ALT_INV_Mux2~1_combout\,
...
-- Equation(s):
-- \state_mach|floor_stop~0_combout\ = ( \state_mach|Mux2~2_combout\ & ( \state_mach|current_state.idle~DUPLICATE_q\ & ( (!\state_mach|destination~DUPLICATE_q\) # (((\state_mach|Mux0~2_combout\) # (\state_mach|i_direction~q\)) # 
-- (\state_mach|Mux1~2_combout\)) ) ) ) # ( !\state_mach|Mux2~2_combout\ & ( \state_mach|current_state.idle~DUPLICATE_q\ & ( ((\state_mach|Mux1~2_combout\ & ((!\state_mach|destination~DUPLICATE_q\) # (!\state_mach|i_direction~q\)))) # 
-- (\state_mach|Mux0~2_combout\) ) ) ) # ( \state_mach|Mux2~2_combout\ & ( !\state_mach|current_state.idle~DUPLICATE_q\ ) ) # ( !\state_mach|Mux2~2_combout\ & ( !\state_mach|current_state.idle~DUPLICATE_q\ & ( (\state_mach|Mux0~2_combout\) # 
-- (\state_mach|Mux1~2_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001111111111111111111111111100110010111111111011111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_Mux1~2_combout\,
	datac => \state_mach|ALT_INV_i_direction~q\,
	datad => \state_mach|ALT_INV_Mux0~2_combout\,
	datae => \state_mach|ALT_INV_Mux2~2_combout\,
	dataf => \state_mach|ALT_INV_current_state.idle~DUPLICATE_q\,
	combout => \state_mach|floor_stop~0_combout\);

-- Location: FF_X62_Y5_N7
\state_mach|floor_stop~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \state_mach|floor_stop~DUPLICATE_q\);

-- Location: LABCELL_X62_Y5_N48
\state_mach|i_current_floor~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_current_floor~0_combout\ = ( \state_mach|Selector1~0_combout\ ) # ( !\state_mach|Selector1~0_combout\ & ( ((!\state_mach|floor_stop~DUPLICATE_q\ & !\state_mach|Selector2~1_combout\)) # (\state_mach|Selector2~0_combout\) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_floor_stop~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_Selector2~0_combout\,
	datad => \state_mach|ALT_INV_Selector2~1_combout\,
	dataf => \state_mach|ALT_INV_Selector1~0_combout\,
	combout => \state_mach|i_current_floor~0_combout\);

-- Location: FF_X62_Y4_N32
\state_mach|i_current_floor[0]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \state_mach|i_current_floor[0]~DUPLICATE_q\);

-- Location: LABCELL_X62_Y5_N33
\state_mach|i_current_floor[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_current_floor[2]~2_combout\ = ( \state_mach|Selector2~2_combout\ & ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ $ (((!\state_mach|i_current_floor[0]~DUPLICATE_q\ & ((\state_mach|Selector1~1_combout\) # 
-- (\state_mach|i_current_floor[1]~DUPLICATE_q\))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\ & ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (!\state_mach|Selector1~1_combout\))))) ) ) # ( !\state_mach|Selector2~2_combout\ & ( 
-- !\state_mach|i_current_floor[2]~DUPLICATE_q\ $ (((!\state_mach|i_current_floor[0]~DUPLICATE_q\) # ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (!\state_mach|Selector1~1_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000111111110000000011111111010000001011111101000000101111110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_i_current_floor[1]~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_Selector1~1_combout\,
	datad => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	dataf => \state_mach|ALT_INV_Selector2~2_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~12_combout\ = ( \SW[4]~input_o\ & ( !\f_control|i_destination_array\(6) & ( ((!\SW[2]~input_o\) # ((!\SW[1]~input_o\) # (\SW[0]~input_o\))) # (\KEY~input_o\) ) ) ) # ( !\SW[4]~input_o\ & ( !\f_control|i_destination_array\(6) 
-- ) )
...
-- Equation(s):
-- \f_control|i_destination_array~13_combout\ = ( \state_mach|Mux0~0_combout\ & ( (!\f_control|i_destination_array~12_combout\ & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # 
-- (\state_mach|i_current_floor[0]~DUPLICATE_q\)))) ) ) # ( !\state_mach|Mux0~0_combout\ & ( !\f_control|i_destination_array~12_combout\ ) )
...
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	datab => \f_control|ALT_INV_i_destination_array~12_combout\,
	datac => \state_mach|ALT_INV_i_current_floor[1]~DUPLICATE_q\,
	datad => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	dataf => \state_mach|ALT_INV_Mux0~0_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~10_combout\ = ( !\f_control|i_destination_array\(3) & ( !\f_control|i_destination_array\(4) & ( (!\f_control|i_destination_array\(6) & (!\f_control|i_destination_array\(5) & !\f_control|i_destination_array\(7))) ) ) )
...
-- Equation(s):
-- \state_mach|i_current_floor[3]~3_combout\ = ( \state_mach|i_current_floor\(3) & ( \state_mach|Selector2~2_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\state_mach|Selector1~1_combout\) # (\state_mach|i_current_floor[1]~DUPLICATE_q\)) # 
-- (\state_mach|i_current_floor\(0)))) # (\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((!\state_mach|i_current_floor\(0)) # ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (!\state_mach|Selector1~1_combout\)))) ) ) ) # ( !\state_mach|i_current_floor\(3) 
-- & ( \state_mach|Selector2~2_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\state_mach|i_current_floor\(0) & (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & !\state_mach|Selector1~1_combout\))) # 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (\state_mach|i_current_floor\(0) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & \state_mach|Selector1~1_combout\))) ) ) ) # ( \state_mach|i_current_floor\(3) & ( !\state_mach|Selector2~2_combout\ & ( 
-- (!\state_mach|i_current_floor[2]~DUPLICATE_q\) # ((!\state_mach|i_current_floor\(0)) # ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (!\state_mach|Selector1~1_combout\))) ) ) ) # ( !\state_mach|i_current_floor\(3) & ( !\state_mach|Selector2~2_combout\ 
-- & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (\state_mach|i_current_floor\(0) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & \state_mach|Selector1~1_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000001111111111111111010000000000000010111111111111110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	...
	datac => \state_mach|ALT_INV_i_current_floor[1]~DUPLICATE_q\,
	datad => \state_mach|ALT_INV_Selector1~1_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~6_combout\ = (!\state_mach|i_current_floor\(3) & ((!\state_mach|check_destination_bits~10_combout\) # ((\f_control|i_destination_array\(2)) # (\f_control|i_destination_array\(1)))))
...
-- Equation(s):
-- \state_mach|i_direction~3_combout\ = ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & (!\state_mach|i_current_floor\(0) & !\state_mach|i_current_floor\(3))) ) )
...
-- Equation(s):
-- \state_mach|i_direction~4_combout\ = ( \state_mach|i_direction~3_combout\ & ( (\state_mach|check_destination_bits~10_combout\ & (!\f_control|i_destination_array\(1) & !\f_control|i_destination_array\(2))) ) ) # ( !\state_mach|i_direction~3_combout\ & ( 
-- (\state_mach|check_destination_bits~10_combout\ & (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & !\f_control|i_destination_array\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000000000000010000000000000001000100000000000100010000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~10_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~14_combout\ = ( \f_control|i_destination_array\(2) & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(6) & (((!\f_control|i_destination_array\(4)) # (\state_mach|i_current_floor[0]~DUPLICATE_q\)) 
-- # (\state_mach|i_current_floor[1]~DUPLICATE_q\))) # (\f_control|i_destination_array\(6) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((\state_mach|i_current_floor[0]~DUPLICATE_q\)))) ) ) ) # ( !\f_control|i_destination_array\(2) & ( 
-- \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(6) & (((!\f_control|i_destination_array\(4)) # (\state_mach|i_current_floor[0]~DUPLICATE_q\)) # (\state_mach|i_current_floor[1]~DUPLICATE_q\))) # 
-- (\f_control|i_destination_array\(6) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((\state_mach|i_current_floor[0]~DUPLICATE_q\)))) ) ) ) # ( \f_control|i_destination_array\(2) & ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( 
-- (!\f_control|i_destination_array\(6) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & (!\f_control|i_destination_array\(4) & \state_mach|i_current_floor[0]~DUPLICATE_q\))) ) ) ) # ( !\f_control|i_destination_array\(2) & ( 
-- !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(6) & (\state_mach|i_current_floor[1]~DUPLICATE_q\ & !\f_control|i_destination_array\(4))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010000000100000000000000010000010100010101110111010001010111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_direction~5_combout\ = ( \state_mach|i_current_floor\(2) & ( \state_mach|i_direction~14_combout\ & ( (!\f_control|i_destination_array\(7) & ((!\f_control|i_destination_array\(5)) # (\state_mach|i_current_floor[1]~DUPLICATE_q\))) ) ) ) # ( 
-- !\state_mach|i_current_floor\(2) & ( \state_mach|i_direction~14_combout\ & ( (!\f_control|i_destination_array\(3) & (!\f_control|i_destination_array\(5) & !\f_control|i_destination_array\(7))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000010000000100000001100000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(3),
...
-- Equation(s):
-- \state_mach|i_direction~13_combout\ = ( !\state_mach|i_current_floor\(2) & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(3) & (((\f_control|i_destination_array\(4))) # (\f_control|i_destination_array\(5)))) # 
-- (\f_control|i_destination_array\(3) & (((!\state_mach|i_current_floor[1]~DUPLICATE_q\)))) ) ) ) # ( \state_mach|i_current_floor\(2) & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(3) & 
-- (\f_control|i_destination_array\(5) & (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & !\f_control|i_destination_array\(4)))) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( 
-- ((\f_control|i_destination_array\(4)) # (\f_control|i_destination_array\(5))) # (\f_control|i_destination_array\(3)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011111111111001000000000000001110010111110100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(3),
...
-- Equation(s):
-- \state_mach|i_direction~0_combout\ = ( \f_control|i_destination_array\(1) & ( \state_mach|Add1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & !\f_control|i_destination_array\(0)) ) ) ) # ( !\f_control|i_destination_array\(1) & ( 
-- \state_mach|Add1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & (!\f_control|i_destination_array\(2) & (!\f_control|i_destination_array\(0) & \state_mach|i_direction~13_combout\))) ) ) ) # ( !\f_control|i_destination_array\(1) & ( 
-- !\state_mach|Add1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & (!\f_control|i_destination_array\(2) & (!\f_control|i_destination_array\(0) & \state_mach|i_direction~13_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010000000000000000000000000000000100000001010000010100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datac => \f_control|ALT_INV_i_destination_array\(0),
	datad => \state_mach|ALT_INV_i_direction~13_combout\,
...
-- Equation(s):
-- \state_mach|LessThan14~0_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & !\state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( 
...
-- Equation(s):
-- \state_mach|check_destination_bits~8_combout\ = ( !\f_control|i_destination_array\(3) & ( !\f_control|i_destination_array\(0) & ( (!\f_control|i_destination_array\(2) & (!\f_control|i_destination_array\(5) & (!\f_control|i_destination_array\(4) & 
-- !\f_control|i_destination_array\(1)))) ) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~9_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (!\state_mach|i_current_floor[1]~DUPLICATE_q\))) ) ) # ( 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) ) )
...
-- Equation(s):
-- \state_mach|i_direction~1_combout\ = ( !\state_mach|i_current_floor\(3) & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (\f_control|i_destination_array\(2) & (!\f_control|i_destination_array\(1) & (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- !\f_control|i_destination_array\(0)))) ) ) )
...
-- Equation(s):
-- \state_mach|i_direction~2_combout\ = ( \state_mach|check_destination_bits~9_combout\ & ( !\state_mach|i_direction~1_combout\ & ( (!\state_mach|check_destination_bits~8_combout\) # ((!\f_control|i_destination_array\(6) & 
-- (!\f_control|i_destination_array\(7))) # (\f_control|i_destination_array\(6) & ((!\state_mach|LessThan14~0_combout\)))) ) ) ) # ( !\state_mach|check_destination_bits~9_combout\ & ( !\state_mach|i_direction~1_combout\ & ( 
-- (!\f_control|i_destination_array\(6)) # ((!\state_mach|LessThan14~0_combout\) # (!\state_mach|check_destination_bits~8_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111100111111111011100000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_direction~7_combout\ = ( \state_mach|i_direction~0_combout\ & ( \state_mach|i_direction~2_combout\ & ( (((\state_mach|i_direction~6_combout\ & !\state_mach|i_direction~5_combout\)) # (\state_mach|i_direction~4_combout\)) # 
-- (\state_mach|i_direction~q\) ) ) ) # ( !\state_mach|i_direction~0_combout\ & ( \state_mach|i_direction~2_combout\ & ( (!\state_mach|i_direction~q\ & (((\state_mach|i_direction~6_combout\ & !\state_mach|i_direction~5_combout\)) # 
-- (\state_mach|i_direction~4_combout\))) ) ) ) # ( \state_mach|i_direction~0_combout\ & ( !\state_mach|i_direction~2_combout\ & ( (((\state_mach|i_direction~6_combout\ & !\state_mach|i_direction~5_combout\)) # (\state_mach|i_direction~4_combout\)) # 
-- (\state_mach|i_direction~q\) ) ) ) # ( !\state_mach|i_direction~0_combout\ & ( !\state_mach|i_direction~2_combout\ & ( (((\state_mach|i_direction~6_combout\ & !\state_mach|i_direction~5_combout\)) # (\state_mach|i_direction~4_combout\)) # 
-- (\state_mach|i_direction~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111111100111111011111110011111101001100000011000111111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_direction~6_combout\,
	datab => \state_mach|ALT_INV_i_direction~q\,
	datac => \state_mach|ALT_INV_i_direction~4_combout\,
	datad => \state_mach|ALT_INV_i_direction~5_combout\,
	datae => \state_mach|ALT_INV_i_direction~0_combout\,
	dataf => \state_mach|ALT_INV_i_direction~2_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~18_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # ((!\f_control|i_floor_call_array_up\(2) & 
-- !\f_control|i_floor_call_array_down\(2))))) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) ) )
...
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(2),
	datab => \state_mach|ALT_INV_i_current_floor[1]~DUPLICATE_q\,
	datac => \f_control|ALT_INV_i_floor_call_array_down\(2),
	datad => \state_mach|ALT_INV_i_current_floor\(3),
	dataf => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~6_combout\ = ( !\f_control|i_floor_call_array_up\(0) & ( !\f_control|i_floor_call_array_down\(1) & ( (!\f_control|i_floor_call_array_down\(0) & !\f_control|i_floor_call_array_up\(1)) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \f_control|ALT_INV_i_floor_call_array_down\(0),
...
-- Equation(s):
-- \state_mach|check_destination_bits~11_combout\ = ( !\f_control|i_floor_call_array_up\(3) & ( (!\f_control|i_floor_call_array_up\(2) & (!\f_control|i_floor_call_array_down\(3) & !\f_control|i_floor_call_array_down\(2))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~12_combout\ = ( \state_mach|check_destination_bits~3_combout\ & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((!\state_mach|check_destination_bits~2_combout\) # 
-- (!\state_mach|check_destination_bits~11_combout\)) # (\state_mach|i_current_floor[0]~DUPLICATE_q\))) ) ) ) # ( !\state_mach|check_destination_bits~3_combout\ & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ ) 
-- ) ) # ( \state_mach|check_destination_bits~3_combout\ & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((!\state_mach|check_destination_bits~11_combout\) # ((\state_mach|i_current_floor[0]~DUPLICATE_q\ & 
-- !\state_mach|check_destination_bits~2_combout\)))) ) ) ) # ( !\state_mach|check_destination_bits~3_combout\ & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- ((!\state_mach|check_destination_bits~11_combout\) # ((\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\state_mach|check_destination_bits~2_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100000100000011110000010000001111000011110000111100001101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~14_combout\ = ( \f_control|i_floor_call_array_down\(0) & ( \state_mach|destination~q\ ) ) # ( !\f_control|i_floor_call_array_down\(0) & ( \state_mach|destination~q\ & ( ((\f_control|i_floor_call_array_up\(1)) # 
-- (\f_control|i_floor_call_array_down\(1))) # (\f_control|i_floor_call_array_up\(0)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(0),
	datab => \f_control|ALT_INV_i_floor_call_array_down\(1),
	datac => \f_control|ALT_INV_i_floor_call_array_up\(1),
	datae => \f_control|ALT_INV_i_floor_call_array_down\(0),
...
-- Equation(s):
-- \state_mach|check_destination_bits~13_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( \state_mach|check_destination_bits~1_combout\ & ( \state_mach|check_destination_bits~2_combout\ ) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~15_combout\ = ( !\f_control|i_floor_call_array_up\(1) & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\f_control|i_floor_call_array_up\(0) & (!\f_control|i_floor_call_array_down\(1) & 
-- (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\f_control|i_floor_call_array_down\(0)))) ) ) ) # ( \f_control|i_floor_call_array_up\(1) & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\) # 
-- ((!\f_control|i_floor_call_array_up\(0) & !\f_control|i_floor_call_array_down\(0))) ) ) ) # ( !\f_control|i_floor_call_array_up\(1) & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\) # 
-- ((!\f_control|i_floor_call_array_up\(0) & !\f_control|i_floor_call_array_down\(0))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111101011110000111110101111000010000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(0),
...
-- Equation(s):
-- \state_mach|check_destination_bits~16_combout\ = ( \state_mach|i_current_floor\(2) & ( \f_control|Decoder1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & (\state_mach|check_destination_bits~1_combout\ & !\state_mach|check_destination_bits~0_combout\)) 
-- ) ) ) # ( !\state_mach|i_current_floor\(2) & ( \f_control|Decoder1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|check_destination_bits~0_combout\) # (\state_mach|check_destination_bits~15_combout\))) ) ) ) # ( 
-- !\state_mach|i_current_floor\(2) & ( !\f_control|Decoder1~0_combout\ & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|check_destination_bits~0_combout\) # (\state_mach|check_destination_bits~15_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010000010101010000000000000000010100000101010100010000000100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
	...
	datad => \state_mach|ALT_INV_check_destination_bits~15_combout\,
	datae => \state_mach|ALT_INV_i_current_floor\(2),
	dataf => \f_control|ALT_INV_Decoder1~0_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~17_combout\ = ( \state_mach|check_destination_bits~13_combout\ & ( \state_mach|check_destination_bits~16_combout\ & ( (!\state_mach|check_destination_bits~3_combout\ & (!\state_mach|LessThan14~0_combout\)) # 
-- (\state_mach|check_destination_bits~3_combout\ & ((!\state_mach|check_destination_bits~9_combout\))) ) ) ) # ( \state_mach|check_destination_bits~13_combout\ & ( !\state_mach|check_destination_bits~16_combout\ & ( 
-- (!\state_mach|check_destination_bits~3_combout\ & (!\state_mach|LessThan14~0_combout\)) # (\state_mach|check_destination_bits~3_combout\ & ((!\state_mach|check_destination_bits~9_combout\))) ) ) ) # ( !\state_mach|check_destination_bits~13_combout\ & ( 
-- !\state_mach|check_destination_bits~16_combout\ & ( !\state_mach|check_destination_bits~14_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101010101010111100111100000000000000000000001111001111000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~14_combout\,
	datab => \state_mach|ALT_INV_check_destination_bits~3_combout\,
	datac => \state_mach|ALT_INV_LessThan14~0_combout\,
	datad => \state_mach|ALT_INV_check_destination_bits~9_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~13_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~19_combout\ = ( \state_mach|check_destination_bits~17_combout\ & ( \state_mach|i_direction~7_combout\ & ( (\state_mach|check_destination_bits~6_combout\ & (\state_mach|destination~DUPLICATE_q\ & 
-- ((!\state_mach|check_destination_bits~18_combout\) # (\state_mach|check_destination_bits~12_combout\)))) ) ) ) # ( !\state_mach|check_destination_bits~17_combout\ & ( \state_mach|i_direction~7_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011111111111111110000000000100011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~18_combout\,
	datab => \state_mach|ALT_INV_check_destination_bits~6_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~12_combout\,
	datad => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	datae => \state_mach|ALT_INV_check_destination_bits~17_combout\,
	dataf => \state_mach|ALT_INV_i_direction~7_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~11_combout\ = ( \state_mach|check_destination_bits~3_combout\ & ( !\state_mach|check_destination_bits~0_combout\ & ( (!\state_mach|LessThan14~0_combout\ & (\state_mach|check_destination_bits~2_combout\ & 
-- (\state_mach|check_destination_bits~1_combout\ & !\state_mach|check_destination_bits~4_combout\))) ) ) )
...
PORT MAP (
	...
	datad => \state_mach|ALT_INV_check_destination_bits~4_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~3_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~20_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( \state_mach|check_destination_bits~3_combout\ & ( (\state_mach|check_destination_bits~2_combout\ & \state_mach|check_destination_bits~1_combout\) ) ) )
...
-- Equation(s):
-- \state_mach|i_direction~8_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( \state_mach|i_current_floor\(2) & ( (\state_mach|check_destination_bits~2_combout\ & (\state_mach|check_destination_bits~1_combout\ & 
-- ((\state_mach|i_current_floor[1]~DUPLICATE_q\) # (\state_mach|i_current_floor\(0))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000100110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(0),
...
-- Equation(s):
-- \state_mach|i_direction~9_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (\f_control|i_floor_call_array_down\(1)) # 
-- (\f_control|i_floor_call_array_up\(1)) ) ) ) # ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (((\f_control|i_floor_call_array_down\(2)) # (\f_control|i_floor_call_array_down\(1))) # 
-- (\f_control|i_floor_call_array_up\(2))) # (\f_control|i_floor_call_array_up\(1)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000011111111111111101011111010111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(1),
...
-- Equation(s):
-- \state_mach|i_direction~15_combout\ = ( !\state_mach|i_current_floor\(2) & ( (!\state_mach|check_destination_bits~1_combout\ & ((((\state_mach|i_direction~9_combout\)) # (\f_control|i_floor_call_array_down\(0))) # (\f_control|i_floor_call_array_up\(0)))) 
-- # (\state_mach|check_destination_bits~1_combout\ & (\state_mach|check_destination_bits~0_combout\ & (((\state_mach|i_direction~9_combout\) # (\f_control|i_floor_call_array_down\(0))) # (\f_control|i_floor_call_array_up\(0))))) ) ) # ( 
-- \state_mach|i_current_floor\(2) & ( ((!\state_mach|check_destination_bits~1_combout\) # ((!\state_mach|check_destination_bits~2_combout\) # ((\state_mach|check_destination_bits~0_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0100110001011111111111001111111111001100111111111111110011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(0),
	...
	datag => \f_control|ALT_INV_i_floor_call_array_down\(0),
	combout => \state_mach|i_direction~15_combout\);

-- Location: LABCELL_X60_Y4_N54
\state_mach|i_direction~10\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_direction~10_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( !\state_mach|check_destination_bits~9_combout\ & ( (\state_mach|check_destination_bits~2_combout\ & (\state_mach|check_destination_bits~4_combout\ & 
-- (\state_mach|check_destination_bits~1_combout\ & \state_mach|check_destination_bits~3_combout\))) ) ) )
...
PORT MAP (
	...
	datab => \state_mach|ALT_INV_check_destination_bits~4_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~1_combout\,
	datad => \state_mach|ALT_INV_check_destination_bits~3_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~0_combout\,
	dataf => \state_mach|ALT_INV_check_destination_bits~9_combout\,
	combout => \state_mach|i_direction~10_combout\);

-- Location: LABCELL_X61_Y4_N15
\state_mach|i_direction~12\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_direction~12_combout\ = ( \state_mach|i_direction~15_combout\ & ( \state_mach|i_direction~10_combout\ ) ) # ( !\state_mach|i_direction~15_combout\ & ( \state_mach|i_direction~10_combout\ ) ) # ( \state_mach|i_direction~15_combout\ & ( 
-- !\state_mach|i_direction~10_combout\ & ( (!\state_mach|check_destination_bits~20_combout\) # (\state_mach|i_direction~11_combout\) ) ) ) # ( !\state_mach|i_direction~15_combout\ & ( !\state_mach|i_direction~10_combout\ & ( 
-- ((!\state_mach|check_destination_bits~20_combout\ & ((\state_mach|i_direction~8_combout\) # (\state_mach|i_current_floor\(3))))) # (\state_mach|i_direction~11_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111010111110101111101011111010111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \state_mach|ALT_INV_i_direction~8_combout\,
	datae => \state_mach|ALT_INV_i_direction~15_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~28_combout\ = ( !\state_mach|check_destination_bits~5_combout\ & ( (!\state_mach|destination~DUPLICATE_q\ & ((!\state_mach|check_destination_bits~21_combout\ & (\state_mach|i_direction~7_combout\)) # 
-- (\state_mach|check_destination_bits~21_combout\ & ((!\state_mach|i_direction~12_combout\) # ((\state_mach|i_direction~7_combout\ & !\state_mach|i_current_floor\(3))))))) # (\state_mach|destination~DUPLICATE_q\ & (\state_mach|i_direction~7_combout\)) ) ) # 
-- ( \state_mach|check_destination_bits~5_combout\ & ( ((!\state_mach|i_direction~12_combout\ & ((!\state_mach|destination~DUPLICATE_q\) # ((\state_mach|i_direction~7_combout\)))) # (\state_mach|i_direction~12_combout\ & 
-- (((\state_mach|check_destination_bits~19_combout\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0011101100111011101110111011101100110011001100010000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_i_direction~7_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~19_combout\,
	datad => \state_mach|ALT_INV_i_current_floor\(3),
	datae => \state_mach|ALT_INV_check_destination_bits~5_combout\,
	dataf => \state_mach|ALT_INV_i_direction~12_combout\,
	datag => \state_mach|ALT_INV_check_destination_bits~21_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~19_combout\ = ( !\state_mach|check_destination_bits~28_combout\ )
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \state_mach|i_direction~19_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|destination~0_combout\ = ( !\f_control|i_destination_array\(2) & ( (!\f_control|i_destination_array\(0) & (!\f_control|i_destination_array\(1) & \state_mach|check_destination_bits~10_combout\)) ) )
...
-- Equation(s):
-- \state_mach|destination~5_combout\ = ( \state_mach|check_destination_bits~8_combout\ & ( \f_control|Decoder1~1_combout\ & ( (!\f_control|i_destination_array\(6) & (\f_control|i_destination_array\(7) & ((!\state_mach|Add0~0_combout\) # 
-- (\state_mach|i_current_floor\(3))))) # (\f_control|i_destination_array\(6) & (((\state_mach|i_current_floor\(3))) # (\state_mach|Add0~0_combout\))) ) ) ) # ( \state_mach|check_destination_bits~8_combout\ & ( !\f_control|Decoder1~1_combout\ & ( 
-- ((\f_control|i_destination_array\(7) & ((!\state_mach|Add0~0_combout\) # (\state_mach|i_current_floor\(3))))) # (\f_control|i_destination_array\(6)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001110110011111100000000000000000001100100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_Add0~0_combout\,
	datab => \f_control|ALT_INV_i_destination_array\(6),
	datac => \f_control|ALT_INV_i_destination_array\(7),
	datad => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \state_mach|check_destination_bits~26_combout\ = ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (\state_mach|i_current_floor\(0) & !\state_mach|i_current_floor\(1))) ) )
...
-- Equation(s):
-- \state_mach|destination~6_combout\ = ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\state_mach|i_current_floor\(3) & \state_mach|i_current_floor[1]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~27_combout\ = ( \state_mach|check_destination_bits~26_combout\ & ( \state_mach|destination~6_combout\ & ( (!\f_control|i_destination_array\(2) & (\state_mach|check_destination_bits~10_combout\ & 
-- (!\state_mach|i_direction~3_combout\ & !\f_control|i_destination_array\(1)))) ) ) ) # ( !\state_mach|check_destination_bits~26_combout\ & ( \state_mach|destination~6_combout\ & ( (!\f_control|i_destination_array\(2) & 
-- (\state_mach|check_destination_bits~10_combout\ & ((!\state_mach|i_direction~3_combout\) # (\f_control|i_destination_array\(1))))) ) ) ) # ( \state_mach|check_destination_bits~26_combout\ & ( !\state_mach|destination~6_combout\ & ( 
-- (\state_mach|check_destination_bits~10_combout\ & (((!\state_mach|i_direction~3_combout\ & !\f_control|i_destination_array\(1))) # (\f_control|i_destination_array\(2)))) ) ) ) # ( !\state_mach|check_destination_bits~26_combout\ & ( 
-- !\state_mach|destination~6_combout\ & ( (\state_mach|check_destination_bits~10_combout\ & (((!\state_mach|i_direction~3_combout\) # (\f_control|i_destination_array\(1))) # (\f_control|i_destination_array\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000100110011001100010001000100100000001000100010000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(2),
	datab => \state_mach|ALT_INV_check_destination_bits~10_combout\,
	datac => \state_mach|ALT_INV_i_direction~3_combout\,
	datad => \f_control|ALT_INV_i_destination_array\(1),
	datae => \state_mach|ALT_INV_check_destination_bits~26_combout\,
	dataf => \state_mach|ALT_INV_destination~6_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~24_combout\ = ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( (\f_control|i_destination_array\(4) & (!\state_mach|i_current_floor\(0) & !\state_mach|i_current_floor\(1))) ) ) ) # ( 
-- !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( (!\f_control|i_destination_array\(4) & (\state_mach|i_current_floor\(0) & \state_mach|i_current_floor\(1))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000001100001100000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|check_destination_bits~23_combout\ = ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & ((!\f_control|i_destination_array\(7) & (!\f_control|i_destination_array\(6) & 
-- !\state_mach|i_current_floor\(1))) # (\f_control|i_destination_array\(7) & ((\state_mach|i_current_floor\(1)))))) ) ) ) # ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\f_control|i_destination_array\(7) & 
-- (\f_control|i_destination_array\(6) & (\state_mach|i_current_floor\(1) & !\state_mach|i_current_floor\(3)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000100000000000000000000000001000010100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(7),
...
-- Equation(s):
-- \state_mach|check_destination_bits~25_combout\ = ( !\state_mach|check_destination_bits~24_combout\ & ( \state_mach|check_destination_bits~23_combout\ & ( (!\f_control|i_destination_array\(7) & (!\f_control|i_destination_array\(6) & 
-- (!\f_control|i_destination_array\(5) & !\state_mach|check_destination_bits~10_combout\))) ) ) ) # ( \state_mach|check_destination_bits~24_combout\ & ( !\state_mach|check_destination_bits~23_combout\ & ( (!\state_mach|check_destination_bits~10_combout\ & 
-- (((\f_control|i_destination_array\(5)) # (\f_control|i_destination_array\(6))) # (\f_control|i_destination_array\(7)))) ) ) ) # ( !\state_mach|check_destination_bits~24_combout\ & ( !\state_mach|check_destination_bits~23_combout\ & ( 
-- !\state_mach|check_destination_bits~10_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111100000000011111110000000010000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(7),
	...
	datac => \f_control|ALT_INV_i_destination_array\(5),
	datad => \state_mach|ALT_INV_check_destination_bits~10_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~24_combout\,
	dataf => \state_mach|ALT_INV_check_destination_bits~23_combout\,
...
-- Equation(s):
-- \state_mach|destination~1_combout\ = ( !\state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor\(0) & (\state_mach|i_current_floor\(1) & !\state_mach|i_current_floor[2]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \state_mach|destination~2_combout\ = ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( (!\f_control|i_destination_array\(1) & (!\state_mach|i_current_floor\(0) & (!\f_control|i_destination_array\(0) $ 
-- (!\state_mach|i_current_floor\(1))))) # (\f_control|i_destination_array\(1) & (!\state_mach|i_current_floor\(1) & (!\f_control|i_destination_array\(0) $ (!\state_mach|i_current_floor\(0))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011010010000000000000000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|destination~3_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & (!\f_control|i_destination_array\(4) & \state_mach|i_current_floor[2]~DUPLICATE_q\)) ) ) ) # ( 
-- !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & (\f_control|i_destination_array\(4) & \state_mach|i_current_floor[2]~DUPLICATE_q\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000100010000000000000000000000000100010000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \state_mach|check_destination_bits~7_combout\ = ( !\f_control|i_destination_array\(1) & ( !\f_control|i_destination_array\(0) & ( !\f_control|i_destination_array\(2) ) ) )
...
-- Equation(s):
-- \state_mach|destination~4_combout\ = ( \state_mach|destination~3_combout\ & ( \state_mach|check_destination_bits~7_combout\ & ( (\f_control|i_destination_array\(3) & (!\state_mach|check_destination_bits~8_combout\ & !\state_mach|destination~1_combout\)) ) 
-- ) ) # ( !\state_mach|destination~3_combout\ & ( \state_mach|check_destination_bits~7_combout\ & ( (!\state_mach|check_destination_bits~8_combout\ & ((!\f_control|i_destination_array\(3)) # (!\state_mach|destination~1_combout\))) ) ) ) # ( 
-- \state_mach|destination~3_combout\ & ( !\state_mach|check_destination_bits~7_combout\ & ( (!\state_mach|check_destination_bits~8_combout\ & !\state_mach|destination~2_combout\) ) ) ) # ( !\state_mach|destination~3_combout\ & ( 
-- !\state_mach|check_destination_bits~7_combout\ & ( (!\state_mach|check_destination_bits~8_combout\ & !\state_mach|destination~2_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000110011000000000011001000110010000100000001000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(3),
	datab => \state_mach|ALT_INV_check_destination_bits~8_combout\,
	datac => \state_mach|ALT_INV_destination~1_combout\,
	datad => \state_mach|ALT_INV_destination~2_combout\,
	datae => \state_mach|ALT_INV_destination~3_combout\,
...
-- Equation(s):
-- \state_mach|destination~7_combout\ = ( \state_mach|check_destination_bits~25_combout\ & ( \state_mach|destination~4_combout\ & ( (!\state_mach|destination~0_combout\) # (\state_mach|i_direction~q\) ) ) ) # ( !\state_mach|check_destination_bits~25_combout\ 
-- & ( \state_mach|destination~4_combout\ & ( ((!\state_mach|destination~0_combout\ & \state_mach|check_destination_bits~27_combout\)) # (\state_mach|i_direction~q\) ) ) ) # ( \state_mach|check_destination_bits~25_combout\ & ( 
-- !\state_mach|destination~4_combout\ & ( (!\state_mach|i_direction~q\ & (!\state_mach|destination~0_combout\)) # (\state_mach|i_direction~q\ & ((\state_mach|destination~5_combout\))) ) ) ) # ( !\state_mach|check_destination_bits~25_combout\ & ( 
-- !\state_mach|destination~4_combout\ & ( (!\state_mach|i_direction~q\ & (!\state_mach|destination~0_combout\ & ((\state_mach|check_destination_bits~27_combout\)))) # (\state_mach|i_direction~q\ & (((\state_mach|destination~5_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010110001101100011011000110101010101110111011101110111011101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_direction~q\,
	datab => \state_mach|ALT_INV_destination~0_combout\,
	datac => \state_mach|ALT_INV_destination~5_combout\,
	datad => \state_mach|ALT_INV_check_destination_bits~27_combout\,
	datae => \state_mach|ALT_INV_check_destination_bits~25_combout\,
	dataf => \state_mach|ALT_INV_destination~4_combout\,
	combout => \state_mach|destination~7_combout\);

-- Location: FF_X63_Y5_N25
\state_mach|destination~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \state_mach|destination~DUPLICATE_q\);
...
-- Equation(s):
-- \state_mach|Selector0~0_combout\ = ( \state_mach|floor_call~q\ & ( (!\state_mach|destination~DUPLICATE_q\ & (((!\state_mach|current_state.loading~q\)))) # (\state_mach|destination~DUPLICATE_q\ & ((!\state_mach|floor_stop~q\) # 
-- ((\state_mach|current_state.idle~DUPLICATE_q\ & !\state_mach|current_state.loading~q\)))) ) ) # ( !\state_mach|floor_call~q\ & ( (!\state_mach|destination~DUPLICATE_q\ & (((\state_mach|current_state.idle~DUPLICATE_q\ & 
-- !\state_mach|current_state.loading~q\)))) # (\state_mach|destination~DUPLICATE_q\ & ((!\state_mach|floor_stop~q\) # ((\state_mach|current_state.idle~DUPLICATE_q\ & !\state_mach|current_state.loading~q\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100111101000100010011110100010011101111010001001110111101000100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_floor_stop~q\,
	datac => \state_mach|ALT_INV_current_state.idle~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|Mux6~0_combout\ = ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & \state_mach|i_current_floor\(0)) ) ) # ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & 
-- ((!\state_mach|i_current_floor\(0)) # (\state_mach|i_current_floor[1]~DUPLICATE_q\))) # (\state_mach|i_current_floor\(3) & ((!\state_mach|i_current_floor[1]~DUPLICATE_q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001111001100111100111100110000001100000011000000110000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \hexF|segs[0]~0_combout\ = ( \state_mach|current_state.down~q\ & ( (!\state_mach|current_state.idle~DUPLICATE_q\) # ((!\hexF|Mux6~0_combout\) # (\state_mach|current_state.up~q\)) ) ) # ( !\state_mach|current_state.down~q\ & ( 
-- (!\state_mach|current_state.idle~DUPLICATE_q\) # ((!\state_mach|current_state.up~q\) # (!\hexF|Mux6~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111010111111111111101011111111101011111111111110101111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~DUPLICATE_q\,
	datac => \state_mach|ALT_INV_current_state.up~q\,
	datad => \hexF|ALT_INV_Mux6~0_combout\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
	combout => \hexF|segs[0]~0_combout\);

-- Location: FF_X62_Y5_N19
\state_mach|current_state.up~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \state_mach|current_state.up~DUPLICATE_q\);

-- Location: LABCELL_X62_Y6_N48
\hexF|Mux5~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \hexF|Mux5~0_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(3) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(3) & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ ) ) ) # ( 
-- \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor[0]~DUPLICATE_q\) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( 
-- !\state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor[2]~DUPLICATE_q\ & \state_mach|i_current_floor[0]~DUPLICATE_q\) ) ) )
...
-- Equation(s):
-- \hexF|Mux5~1_combout\ = ( \state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ & ( (\hexF|Mux5~0_combout\) # (\state_mach|current_state.up~DUPLICATE_q\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ 
-- ) ) # ( \state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ & ( (!\state_mach|current_state.up~DUPLICATE_q\) # (\hexF|Mux5~0_combout\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111101011111010111111111111111111110101111101011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.up~DUPLICATE_q\,
	datac => \hexF|ALT_INV_Mux5~0_combout\,
	datae => \state_mach|ALT_INV_current_state.idle~q\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux4~0_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( \state_mach|i_current_floor\(3) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( 
-- (\state_mach|i_current_floor\(3) & \state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) ) # ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\) # 
-- (\state_mach|i_current_floor\(3)) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (\state_mach|i_current_floor\(3) & \state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000101111101011111010100000101000001010101010101010101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \hexF|Mux4~1_combout\ = ( \state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ & ( (\state_mach|current_state.up~DUPLICATE_q\) # (\hexF|Mux4~0_combout\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ 
-- ) ) # ( \state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ & ( (!\state_mach|current_state.up~DUPLICATE_q\) # (\hexF|Mux4~0_combout\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111111100111111001111111111111111110011111100111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \hexF|ALT_INV_Mux4~0_combout\,
	datac => \state_mach|ALT_INV_current_state.up~DUPLICATE_q\,
	datae => \state_mach|ALT_INV_current_state.idle~q\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux3~0_combout\ = ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & (!\state_mach|i_current_floor[1]~DUPLICATE_q\ $ (!\state_mach|i_current_floor[2]~DUPLICATE_q\))) ) ) # ( !\state_mach|i_current_floor\(0) & ( 
-- (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & (!\state_mach|i_current_floor\(3))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111110000001100111111000000110000001100110000000000110011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \hexF|segs[3]~1_combout\ = ( \hexF|Mux3~0_combout\ & ( (!\state_mach|current_state.idle~DUPLICATE_q\) # ((\state_mach|current_state.up~q\ & \state_mach|current_state.down~q\)) ) ) # ( !\hexF|Mux3~0_combout\ & ( 
-- ((!\state_mach|current_state.idle~DUPLICATE_q\) # (\state_mach|current_state.down~q\)) # (\state_mach|current_state.up~q\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111101011111111111110101111111111111000001011111111100000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.up~q\,
	datac => \state_mach|ALT_INV_current_state.down~q\,
	datad => \state_mach|ALT_INV_current_state.idle~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|Mux2~0_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor[0]~DUPLICATE_q\) ) ) ) # ( 
-- \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( 
-- (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor[0]~DUPLICATE_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100000011000000111100001111000011000000110000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|segs[4]~2_combout\ = ( \state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ & ( (!\hexF|Mux2~0_combout\) # (\state_mach|current_state.up~DUPLICATE_q\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( 
-- \state_mach|current_state.down~q\ ) ) # ( \state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ & ( (\state_mach|current_state.up~DUPLICATE_q\ & !\hexF|Mux2~0_combout\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( 
-- !\state_mach|current_state.down~q\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111010100000101000011111111111111111111010111110101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.up~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|Mux1~0_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(3) & ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ ) ) ) # ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor[0]~DUPLICATE_q\) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\) # 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001111110011001100000011000011001100110011000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|segs[5]~3_combout\ = ( \state_mach|current_state.idle~q\ & ( \hexF|Mux1~0_combout\ & ( (\state_mach|current_state.down~q\ & \state_mach|current_state.up~DUPLICATE_q\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( \hexF|Mux1~0_combout\ ) ) # ( 
-- \state_mach|current_state.idle~q\ & ( !\hexF|Mux1~0_combout\ & ( (\state_mach|current_state.up~DUPLICATE_q\) # (\state_mach|current_state.down~q\) ) ) ) # ( !\state_mach|current_state.idle~q\ & ( !\hexF|Mux1~0_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111010111110101111111111111111111110000010100000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux0~0_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & \state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( 
-- \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & !\state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(3) & 
-- !\state_mach|i_current_floor[2]~DUPLICATE_q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010000010100000000000000000000010100000101000000000101000001010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \hexF|segs[6]~4_combout\ = ( \state_mach|current_state.idle~DUPLICATE_q\ & ( \state_mach|current_state.up~q\ & ( (!\state_mach|current_state.down~q\ & \hexF|Mux0~0_combout\) ) ) ) # ( \state_mach|current_state.idle~DUPLICATE_q\ & ( 
-- !\state_mach|current_state.up~q\ & ( (!\state_mach|current_state.down~q\) # (\hexF|Mux0~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101011111010111100000000000000000000101000001010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.down~q\,
