...
SIGNAL \state_mach|floor_stop~1_combout\ : std_logic;
SIGNAL \state_mach|floor_stop~0_combout\ : std_logic;
SIGNAL \state_mach|floor_stop~2_combout\ : std_logic;
...
SIGNAL \state_mach|Selector1~2_combout\ : std_logic;
...
SIGNAL \state_mach|ALT_INV_floor_stop~1_combout\ : std_logic;
...
SIGNAL \state_mach|ALT_INV_Selector1~2_combout\ : std_logic;
SIGNAL \state_mach|ALT_INV_Selector1~1_combout\ : std_logic;
SIGNAL \state_mach|ALT_INV_i_current_floor~0_combout\ : std_logic;
...
\state_mach|ALT_INV_floor_stop~1_combout\ <= NOT \state_mach|floor_stop~1_combout\;
...
\state_mach|ALT_INV_Selector1~2_combout\ <= NOT \state_mach|Selector1~2_combout\;
\state_mach|ALT_INV_Selector1~1_combout\ <= NOT \state_mach|Selector1~1_combout\;
\state_mach|ALT_INV_i_current_floor~0_combout\ <= NOT \state_mach|i_current_floor~0_combout\;
...
-- Equation(s):
-- \count1|Equal0~1_combout\ = ( \count1|i_count\(13) & ( \count1|i_count\(12) & ( (\count1|i_count\(17) & (\count1|i_count\(14) & (!\count1|i_count\(16) & \count1|i_count\(15)))) ) ) )
...
PORT MAP (
	...
	dataf => \count1|ALT_INV_i_count\(12),
	combout => \count1|Equal0~1_combout\);

-- Location: LABCELL_X64_Y7_N12
\count1|Equal0~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \count1|Equal0~0_combout\ = ( !\count1|i_count\(11) & ( (!\count1|i_count\(10) & (!\count1|i_count\(9) & !\count1|i_count\(8))) ) )
...
-- Equation(s):
-- \count1|Equal0~4_combout\ = ( !\count1|i_count\(6) & ( (\count1|i_count\(23) & (!\count1|i_count\(26) & (!\count1|i_count\(24) & \count1|i_count\(25)))) ) )
...
-- Equation(s):
-- \count1|Equal0~2_combout\ = ( !\count1|i_count\(18) & ( \count1|i_count\(21) & ( (\count1|i_count\(22) & (!\count1|i_count\(4) & (\count1|i_count\(19) & \count1|i_count\(20)))) ) ) )
...
PORT MAP (
	...
	datae => \count1|ALT_INV_i_count\(18),
	dataf => \count1|ALT_INV_i_count\(21),
...
-- Equation(s):
-- \rtl~0_combout\ = LCELL(( \count1|Equal0~2_combout\ & ( \count1|Equal0~3_combout\ & ( (\count1|Equal0~1_combout\ & (!\count1|i_count\(5) & (\count1|Equal0~0_combout\ & \count1|Equal0~4_combout\))) ) ) ))
...
PORT MAP (
	...
	datac => \count1|ALT_INV_Equal0~0_combout\,
	datad => \count1|ALT_INV_Equal0~4_combout\,
	datae => \count1|ALT_INV_Equal0~2_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~4_combout\ = ( \SW[4]~input_o\ & ( (\SW[1]~input_o\ & (!\SW[2]~input_o\ & (!\SW[0]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~2_combout\ = ( \KEY~input_o\ & ( !\SW[1]~input_o\ & ( (\SW[4]~input_o\ & (\SW[0]~input_o\ & !\SW[2]~input_o\)) ) ) )
...
-- Equation(s):
-- \f_control|Decoder1~2_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(2) & !\state_mach|i_current_floor[1]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~6_combout\ = ( \SW[0]~input_o\ & ( (\SW[1]~input_o\ & (!\SW[2]~input_o\ & (\SW[4]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~12_combout\ = ( !\f_control|i_destination_array\(6) & ( \SW[0]~input_o\ ) ) # ( !\f_control|i_destination_array\(6) & ( !\SW[0]~input_o\ & ( (!\SW[4]~input_o\) # ((!\KEY~input_o\) # ((!\SW[1]~input_o\) # (!\SW[2]~input_o\))) 
-- ) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~13_combout\ = ( \state_mach|i_current_floor\(2) & ( (!\f_control|i_destination_array~12_combout\ & ((!\state_mach|Mux0~0_combout\) # ((!\state_mach|i_current_floor[1]~DUPLICATE_q\) # 
-- (\state_mach|i_current_floor[0]~DUPLICATE_q\)))) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\f_control|i_destination_array~12_combout\ ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~12_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~10_combout\ = ( \SW[0]~input_o\ & ( (!\SW[1]~input_o\ & (\SW[2]~input_o\ & (\SW[4]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|Decoder1~6_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (\state_mach|i_current_floor\(2) & !\state_mach|i_current_floor[1]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~11_combout\ = ( \f_control|i_destination_array\(5) & ( \state_mach|Mux0~0_combout\ & ( (!\f_control|Decoder1~6_combout\) # ((!\state_mach|i_current_floor\(2) & !\state_mach|Mux0~1_combout\)) ) ) ) # ( 
-- !\f_control|i_destination_array\(5) & ( \state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~10_combout\ & ((!\f_control|Decoder1~6_combout\) # ((!\state_mach|i_current_floor\(2) & !\state_mach|Mux0~1_combout\)))) ) ) ) # ( 
-- \f_control|i_destination_array\(5) & ( !\state_mach|Mux0~0_combout\ & ( ((!\f_control|Decoder1~6_combout\) # (!\state_mach|Mux0~1_combout\)) # (\state_mach|i_current_floor\(2)) ) ) ) # ( !\f_control|i_destination_array\(5) & ( !\state_mach|Mux0~0_combout\ 
-- & ( (\f_control|i_destination_array~10_combout\ & (((!\f_control|Decoder1~6_combout\) # (!\state_mach|Mux0~1_combout\)) # (\state_mach|i_current_floor\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101010001111111111111001101010100010100001111110011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|Add0~0_combout\ = ( \state_mach|i_current_floor\(2) & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ ) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~14_combout\ = ( \SW[4]~input_o\ & ( (\SW[1]~input_o\ & (\SW[2]~input_o\ & (\SW[0]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~15_combout\ = ( \f_control|i_destination_array\(7) & ( \state_mach|Mux0~0_combout\ & ( (!\state_mach|Add0~0_combout\) # ((!\state_mach|i_current_floor\(2) & !\state_mach|Mux0~1_combout\)) ) ) ) # ( 
-- !\f_control|i_destination_array\(7) & ( \state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~14_combout\ & ((!\state_mach|Add0~0_combout\) # ((!\state_mach|i_current_floor\(2) & !\state_mach|Mux0~1_combout\)))) ) ) ) # ( 
-- \f_control|i_destination_array\(7) & ( !\state_mach|Mux0~0_combout\ & ( ((!\state_mach|Add0~0_combout\) # (!\state_mach|Mux0~1_combout\)) # (\state_mach|i_current_floor\(2)) ) ) ) # ( !\f_control|i_destination_array\(7) & ( !\state_mach|Mux0~0_combout\ & 
-- ( (\f_control|i_destination_array~14_combout\ & (((!\state_mach|Add0~0_combout\) # (!\state_mach|Mux0~1_combout\)) # (\state_mach|i_current_floor\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001101111111111101110100001110000011001110111011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \f_control|i_destination_array~8_combout\ = ( !\SW[0]~input_o\ & ( (!\SW[1]~input_o\ & (\SW[2]~input_o\ & (\SW[4]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|Decoder1~0_combout\ = ( !\state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor\(0) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~9_combout\ = ( \f_control|Decoder1~0_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\state_mach|i_current_floor\(2) & ((\f_control|i_destination_array~8_combout\) # (\f_control|i_destination_array\(4)))) ) ) ) # ( 
-- !\f_control|Decoder1~0_combout\ & ( \state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~8_combout\) # (\f_control|i_destination_array\(4)) ) ) ) # ( \f_control|Decoder1~0_combout\ & ( !\state_mach|Mux0~0_combout\ & ( 
-- (\f_control|i_destination_array~8_combout\) # (\f_control|i_destination_array\(4)) ) ) ) # ( !\f_control|Decoder1~0_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array~8_combout\) # (\f_control|i_destination_array\(4)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001111111111001100111111111100110011111111110011000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \f_control|ALT_INV_i_destination_array\(4),
	datac => \state_mach|ALT_INV_i_current_floor\(2),
	datad => \f_control|ALT_INV_i_destination_array~8_combout\,
	datae => \f_control|ALT_INV_Decoder1~0_combout\,
	dataf => \state_mach|ALT_INV_Mux0~0_combout\,
...
-- Equation(s):
-- \state_mach|Mux0~0_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \f_control|i_destination_array\(4) & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_destination_array\(5))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & 
-- ((\f_control|i_destination_array\(7)))) ) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \f_control|i_destination_array\(4) & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (\f_control|i_destination_array\(6)) ) ) ) # ( 
-- \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\f_control|i_destination_array\(4) & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_destination_array\(5))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & 
-- ((\f_control|i_destination_array\(7)))) ) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\f_control|i_destination_array\(4) & ( (\f_control|i_destination_array\(6) & \state_mach|i_current_floor[1]~DUPLICATE_q\) ) ) )
...
PORT MAP (
	...
	datae => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|Decoder1~4_combout\ = ( \state_mach|i_current_floor\(0) & ( (\state_mach|i_current_floor[1]~DUPLICATE_q\ & !\state_mach|i_current_floor\(2)) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~7_combout\ = ( \state_mach|i_current_floor\(2) & ( \f_control|Decoder1~4_combout\ & ( (!\state_mach|Mux0~0_combout\ & ((\f_control|i_destination_array~6_combout\) # (\f_control|i_destination_array\(3)))) ) ) ) # ( 
-- !\state_mach|i_current_floor\(2) & ( \f_control|Decoder1~4_combout\ & ( (!\state_mach|Mux0~1_combout\ & ((\f_control|i_destination_array~6_combout\) # (\f_control|i_destination_array\(3)))) ) ) ) # ( \state_mach|i_current_floor\(2) & ( 
-- !\f_control|Decoder1~4_combout\ & ( (\f_control|i_destination_array~6_combout\) # (\f_control|i_destination_array\(3)) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\f_control|Decoder1~4_combout\ & ( (\f_control|i_destination_array~6_combout\) # 
-- (\f_control|i_destination_array\(3)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101111101011111010111110101111101001100010011000101111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \state_mach|ALT_INV_Mux0~0_combout\,
	datae => \state_mach|ALT_INV_i_current_floor\(2),
	dataf => \f_control|ALT_INV_Decoder1~4_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~0_combout\ = ( \SW[4]~input_o\ & ( (!\SW[1]~input_o\ & (!\SW[2]~input_o\ & (!\SW[0]~input_o\ & \KEY~input_o\))) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~1_combout\ = ( \state_mach|i_current_floor\(2) & ( \state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(0)) # (\f_control|i_destination_array~0_combout\) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( 
-- \state_mach|Mux0~1_combout\ & ( (!\f_control|Decoder1~0_combout\ & ((\f_control|i_destination_array\(0)) # (\f_control|i_destination_array~0_combout\))) ) ) ) # ( \state_mach|i_current_floor\(2) & ( !\state_mach|Mux0~1_combout\ & ( 
-- (\f_control|i_destination_array\(0)) # (\f_control|i_destination_array~0_combout\) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\state_mach|Mux0~1_combout\ & ( (\f_control|i_destination_array\(0)) # (\f_control|i_destination_array~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011101110111011101110111011101110000011100000111011101110111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array~0_combout\,
...
-- Equation(s):
-- \state_mach|Mux0~1_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(1) & ( \f_control|i_destination_array\(3) ) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(1) & ( 
-- \f_control|i_destination_array\(2) ) ) ) # ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(1) & ( \f_control|i_destination_array\(1) ) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( 
-- !\state_mach|i_current_floor\(1) & ( \f_control|i_destination_array\(0) ) ) )
...
-- Equation(s):
-- \f_control|i_destination_array~3_combout\ = ( \state_mach|Mux0~1_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\f_control|Decoder1~2_combout\ & ((\f_control|i_destination_array\(1)) # (\f_control|i_destination_array~2_combout\))) ) ) ) # ( 
-- !\state_mach|Mux0~1_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\f_control|i_destination_array\(1))) # (\f_control|i_destination_array~2_combout\))) # (\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- (!\f_control|Decoder1~2_combout\ & ((\f_control|i_destination_array\(1)) # (\f_control|i_destination_array~2_combout\)))) ) ) ) # ( \state_mach|Mux0~1_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- (!\f_control|Decoder1~2_combout\ & ((\f_control|i_destination_array\(1)) # (\f_control|i_destination_array~2_combout\)))) # (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\f_control|i_destination_array\(1))) # 
-- (\f_control|i_destination_array~2_combout\))) ) ) ) # ( !\state_mach|Mux0~1_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array\(1)) # (\f_control|i_destination_array~2_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011111100111111001111110001010100111111001010100011111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[2]~DUPLICATE_q\,
	datab => \f_control|ALT_INV_i_destination_array~2_combout\,
	datac => \f_control|ALT_INV_i_destination_array\(1),
	datad => \f_control|ALT_INV_Decoder1~2_combout\,
	datae => \state_mach|ALT_INV_Mux0~1_combout\,
	dataf => \state_mach|ALT_INV_Mux0~0_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~10_combout\ = ( !\f_control|i_destination_array\(4) & ( !\f_control|i_destination_array\(7) & ( (!\f_control|i_destination_array\(3) & (!\f_control|i_destination_array\(6) & !\f_control|i_destination_array\(5))) ) ) )
...
-- Equation(s):
-- \state_mach|destination~0_combout\ = ( \state_mach|check_destination_bits~10_combout\ & ( (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & !\f_control|i_destination_array\(2))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~8_combout\ = ( !\f_control|i_destination_array\(4) & ( !\f_control|i_destination_array\(2) & ( (!\f_control|i_destination_array\(5) & (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & 
-- !\f_control|i_destination_array\(3)))) ) ) )
...
-- Equation(s):
-- \f_control|Decoder1~1_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \state_mach|i_current_floor[3]~3_combout\ = ( \state_mach|i_current_floor~0_combout\ & ( \state_mach|Selector1~2_combout\ & ( !\state_mach|i_current_floor\(3) $ (((!\state_mach|i_current_floor[0]~DUPLICATE_q\) # ((!\state_mach|i_current_floor\(2)) # 
-- (!\state_mach|i_current_floor\(1))))) ) ) ) # ( !\state_mach|i_current_floor~0_combout\ & ( \state_mach|Selector1~2_combout\ & ( \state_mach|i_current_floor\(3) ) ) ) # ( \state_mach|i_current_floor~0_combout\ & ( !\state_mach|Selector1~2_combout\ & ( 
-- !\state_mach|i_current_floor\(3) $ ((((\state_mach|i_current_floor\(1)) # (\state_mach|i_current_floor\(2))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\))) ) ) ) # ( !\state_mach|i_current_floor~0_combout\ & ( !\state_mach|Selector1~2_combout\ & ( 
-- \state_mach|i_current_floor\(3) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011100100110011001100110011001100110011001100110110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datae => \state_mach|ALT_INV_i_current_floor~0_combout\,
	dataf => \state_mach|ALT_INV_Selector1~2_combout\,
...
-- Equation(s):
-- \state_mach|destination~5_combout\ = ( \f_control|i_destination_array\(6) & ( \state_mach|Add0~0_combout\ & ( \state_mach|check_destination_bits~8_combout\ ) ) ) # ( !\f_control|i_destination_array\(6) & ( \state_mach|Add0~0_combout\ & ( 
-- (\f_control|i_destination_array\(7) & (\state_mach|check_destination_bits~8_combout\ & \state_mach|i_current_floor[3]~DUPLICATE_q\)) ) ) ) # ( \f_control|i_destination_array\(6) & ( !\state_mach|Add0~0_combout\ & ( 
-- (\state_mach|check_destination_bits~8_combout\ & ((!\f_control|Decoder1~1_combout\) # (\state_mach|i_current_floor[3]~DUPLICATE_q\))) ) ) ) # ( !\f_control|i_destination_array\(6) & ( !\state_mach|Add0~0_combout\ & ( (\f_control|i_destination_array\(7) & 
-- \state_mach|check_destination_bits~8_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001001100000011001100000000000100010011001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_direction~3_combout\ = ( !\state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor\(0) & (!\state_mach|i_current_floor[3]~DUPLICATE_q\ & !\state_mach|i_current_floor[2]~DUPLICATE_q\)) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~26_combout\ = ( !\state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor[0]~DUPLICATE_q\ & (!\state_mach|i_current_floor\(1) & !\state_mach|i_current_floor\(2))) ) )
...
-- Equation(s):
-- \state_mach|destination~6_combout\ = ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(2) & (!\state_mach|i_current_floor\(3) & \state_mach|i_current_floor\(1))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~27_combout\ = ( \state_mach|destination~6_combout\ & ( \state_mach|check_destination_bits~10_combout\ & ( (!\f_control|i_destination_array\(2) & ((!\f_control|i_destination_array\(1) & 
-- (!\state_mach|i_direction~3_combout\)) # (\f_control|i_destination_array\(1) & ((!\state_mach|check_destination_bits~26_combout\))))) ) ) ) # ( !\state_mach|destination~6_combout\ & ( \state_mach|check_destination_bits~10_combout\ & ( 
-- ((!\f_control|i_destination_array\(1) & (!\state_mach|i_direction~3_combout\)) # (\f_control|i_destination_array\(1) & ((!\state_mach|check_destination_bits~26_combout\)))) # (\f_control|i_destination_array\(2)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011011000111111111101100000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(1),
	datab => \state_mach|ALT_INV_i_direction~3_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~23_combout\ = ( \state_mach|i_current_floor\(2) & ( \state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor\(3) & ((!\f_control|i_destination_array\(7) & (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & 
-- \f_control|i_destination_array\(6))) # (\f_control|i_destination_array\(7) & (\state_mach|i_current_floor[0]~DUPLICATE_q\)))) ) ) ) # ( \state_mach|i_current_floor\(2) & ( !\state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor\(3) & 
-- (!\f_control|i_destination_array\(7) & (\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\f_control|i_destination_array\(6)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000010000000000000000000000000000000001010000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|check_destination_bits~24_combout\ = ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & (\f_control|i_destination_array\(4) & (!\state_mach|i_current_floor\(1) & \state_mach|i_current_floor\(2)))) # 
-- (\state_mach|i_current_floor[0]~DUPLICATE_q\ & (!\f_control|i_destination_array\(4) & (\state_mach|i_current_floor\(1) & !\state_mach|i_current_floor\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010000100000000001000010000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~25_combout\ = ( \state_mach|check_destination_bits~24_combout\ & ( \f_control|i_destination_array\(7) & ( (!\state_mach|check_destination_bits~10_combout\ & !\state_mach|check_destination_bits~23_combout\) ) ) ) # ( 
-- !\state_mach|check_destination_bits~24_combout\ & ( \f_control|i_destination_array\(7) & ( (!\state_mach|check_destination_bits~10_combout\ & !\state_mach|check_destination_bits~23_combout\) ) ) ) # ( \state_mach|check_destination_bits~24_combout\ & ( 
-- !\f_control|i_destination_array\(7) & ( (!\state_mach|check_destination_bits~10_combout\ & (!\state_mach|check_destination_bits~23_combout\ & ((\f_control|i_destination_array\(5)) # (\f_control|i_destination_array\(6))))) ) ) ) # ( 
-- !\state_mach|check_destination_bits~24_combout\ & ( !\f_control|i_destination_array\(7) & ( (!\state_mach|check_destination_bits~10_combout\ & ((!\state_mach|check_destination_bits~23_combout\) # ((!\f_control|i_destination_array\(6) & 
-- !\f_control|i_destination_array\(5))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010100010100000001000001010000010100000101000001010000010100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|destination~2_combout\ = ( !\state_mach|i_current_floor\(2) & ( \state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor\(3) & (!\f_control|i_destination_array\(0) & (!\f_control|i_destination_array\(1) & 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\))) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor\(3) & ((!\f_control|i_destination_array\(0) & (\f_control|i_destination_array\(1) & 
-- \state_mach|i_current_floor[0]~DUPLICATE_q\)) # (\f_control|i_destination_array\(0) & ((!\state_mach|i_current_floor[0]~DUPLICATE_q\))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0010001000001000000000000000000010000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \state_mach|destination~3_combout\ = ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor\(1) & (\state_mach|i_current_floor\(2) & (!\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\f_control|i_destination_array\(4))))) ) )
...
-- Equation(s):
-- \state_mach|destination~1_combout\ = ( !\state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor\(1) & (\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\state_mach|i_current_floor\(2))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~7_combout\ = ( !\f_control|i_destination_array\(0) & ( (!\f_control|i_destination_array\(2) & !\f_control|i_destination_array\(1)) ) )
...
-- Equation(s):
-- \state_mach|destination~4_combout\ = ( !\state_mach|check_destination_bits~8_combout\ & ( \state_mach|check_destination_bits~7_combout\ & ( (!\f_control|i_destination_array\(3) & (!\state_mach|destination~3_combout\)) # (\f_control|i_destination_array\(3) 
-- & ((!\state_mach|destination~1_combout\))) ) ) ) # ( !\state_mach|check_destination_bits~8_combout\ & ( !\state_mach|check_destination_bits~7_combout\ & ( !\state_mach|destination~2_combout\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101010101010000000000000000011110011110000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~2_combout\,
	datab => \f_control|ALT_INV_i_destination_array\(3),
	datac => \state_mach|ALT_INV_destination~3_combout\,
	datad => \state_mach|ALT_INV_destination~1_combout\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000001110100011101000111010001100001111101011111010111110101111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~0_combout\,
	datab => \state_mach|ALT_INV_destination~5_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~2_combout\ = (!\SW[4]~input_o\ & (\KEY~input_o\ & !\SW[3]~input_o\))
...
-- Equation(s):
-- \state_mach|Selector1~0_combout\ = ( \state_mach|current_state.loading~q\ & ( \state_mach|destination~q\ ) )
...
-- Equation(s):
-- \state_mach|Selector2~1_combout\ = ( \state_mach|Selector2~0_combout\ & ( ((\state_mach|current_state.down~q\ & !\state_mach|floor_stop~DUPLICATE_q\)) # (\state_mach|i_direction~q\) ) ) # ( !\state_mach|Selector2~0_combout\ & ( 
-- (!\state_mach|floor_stop~DUPLICATE_q\ & (((\state_mach|i_direction~q\ & \state_mach|Selector1~0_combout\)) # (\state_mach|current_state.down~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001110000010100000111000001110011011100110111001101110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
PORT MAP (
	clk => \rtl~0_combout\,
	asdata => \state_mach|Selector2~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~0_combout\ = ( !\state_mach|i_direction~q\ & ( (\state_mach|current_state.idle~q\ & ((!\state_mach|current_state.up~q\) # (!\state_mach|current_state.down~q\))) ) )
...
-- Equation(s):
-- \f_control|Decoder1~3_combout\ = ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(2) ) ) )
...
PORT MAP (
	...
	datad => \f_control|ALT_INV_Decoder1~3_combout\,
...
-- Equation(s):
-- \f_control|Decoder0~0_combout\ = ( !\SW[2]~input_o\ & ( (!\SW[1]~input_o\ & \SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~3_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( (!\f_control|Decoder1~2_combout\ & (((\f_control|Decoder0~0_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(1)))) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|Decoder0~0_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(1)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111101011111000011110101111100001100010011000000110001001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~0_combout\,
...
-- Equation(s):
-- \state_mach|Add1~0_combout\ = ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor\(1) & !\state_mach|i_current_floor[2]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \f_control|Decoder0~1_combout\ = ( !\SW[2]~input_o\ & ( (!\SW[1]~input_o\ & !\SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~4_combout\ = ( \f_control|Decoder0~1_combout\ & ( (!\f_control|i_floor_call_array_down~2_combout\ & (\f_control|i_floor_call_array_down\(0) & ((!\f_control|i_floor_call_array_down~1_combout\) # 
-- (!\state_mach|Add1~0_combout\)))) # (\f_control|i_floor_call_array_down~2_combout\ & ((!\f_control|i_floor_call_array_down~1_combout\) # ((!\state_mach|Add1~0_combout\)))) ) ) # ( !\f_control|Decoder0~1_combout\ & ( (\f_control|i_floor_call_array_down\(0) 
-- & ((!\f_control|i_floor_call_array_down~1_combout\) # (!\state_mach|Add1~0_combout\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111100001100000011110000110001011111010011000101111101001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_down~1_combout\,
	datac => \f_control|ALT_INV_i_floor_call_array_down\(0),
	datad => \state_mach|ALT_INV_Add1~0_combout\,
	dataf => \f_control|ALT_INV_Decoder0~1_combout\,
...
-- Equation(s):
-- \state_mach|Mux2~1_combout\ = ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \f_control|i_floor_call_array_down\(3) ) ) ) # ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( 
-- \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \f_control|i_floor_call_array_down\(2) ) ) ) # ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \f_control|i_floor_call_array_down\(1) ) ) ) # ( 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \f_control|i_floor_call_array_down\(0) ) ) )
...
-- Equation(s):
-- \f_control|Decoder0~4_combout\ = ( \SW[2]~input_o\ & ( (!\SW[1]~input_o\ & !\SW[0]~input_o\) ) )
...
-- Equation(s):
-- \f_control|Decoder1~5_combout\ = ( \f_control|Decoder1~0_combout\ & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~7_combout\ = ( !\f_control|Decoder1~5_combout\ & ( \f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~4_combout\)) # 
-- (\f_control|i_floor_call_array_down\(4)) ) ) ) # ( \f_control|Decoder1~5_combout\ & ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~4_combout\)) # 
-- (\f_control|i_floor_call_array_down\(4)) ) ) ) # ( !\f_control|Decoder1~5_combout\ & ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|i_floor_call_array_down~2_combout\ & \f_control|Decoder0~4_combout\)) # 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010101110111010101010111011101010101011101110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~8_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( (!\f_control|Decoder1~6_combout\ & (((\f_control|Decoder0~5_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(5)))) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|Decoder0~5_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(5)) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~5_combout\,
...
-- Equation(s):
-- \f_control|Decoder1~7_combout\ = ( \f_control|Decoder1~1_combout\ & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~9_combout\ = ( \f_control|i_floor_call_array_down\(6) & ( (!\f_control|i_floor_call_array_down~1_combout\) # (!\f_control|Decoder1~7_combout\) ) ) # ( !\f_control|i_floor_call_array_down\(6) & ( 
-- (\f_control|i_floor_call_array_down~2_combout\ & (\f_control|Decoder0~6_combout\ & ((!\f_control|i_floor_call_array_down~1_combout\) # (!\f_control|Decoder1~7_combout\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010100000100000001010000010011111111110011001111111111001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down~2_combout\,
...
-- Equation(s):
-- \state_mach|Mux2~0_combout\ = ( \f_control|i_floor_call_array_down\(6) & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\) # (\f_control|i_floor_call_array_down\(7)) ) ) ) # ( 
-- !\f_control|i_floor_call_array_down\(6) & ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (\state_mach|i_current_floor[0]~DUPLICATE_q\ & \f_control|i_floor_call_array_down\(7)) ) ) ) # ( \f_control|i_floor_call_array_down\(6) & ( 
-- !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & (\f_control|i_floor_call_array_down\(4))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\ & ((\f_control|i_floor_call_array_down\(5)))) ) ) ) # ( 
-- !\f_control|i_floor_call_array_down\(6) & ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & (\f_control|i_floor_call_array_down\(4))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\ & 
-- ((\f_control|i_floor_call_array_down\(5)))) ) ) )
...
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down\(4),
	datab => \f_control|ALT_INV_i_floor_call_array_down\(5),
	datac => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~1_combout\ = ( \state_mach|i_current_floor\(2) & ( \state_mach|Mux2~0_combout\ & ( !\f_control|i_floor_call_array_down~0_combout\ ) ) ) # ( !\state_mach|i_current_floor\(2) & ( \state_mach|Mux2~0_combout\ & ( 
-- (!\f_control|i_floor_call_array_down~0_combout\ & \state_mach|Mux2~1_combout\) ) ) ) # ( !\state_mach|i_current_floor\(2) & ( !\state_mach|Mux2~0_combout\ & ( (!\f_control|i_floor_call_array_down~0_combout\ & \state_mach|Mux2~1_combout\) ) ) )
...
PORT MAP (
	...
	datae => \state_mach|ALT_INV_i_current_floor\(2),
	dataf => \state_mach|ALT_INV_Mux2~0_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_down~10_combout\ = ( \f_control|i_floor_call_array_down~1_combout\ & ( (!\state_mach|Add0~0_combout\ & (((\f_control|Decoder0~7_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # 
-- (\f_control|i_floor_call_array_down\(7)))) ) ) # ( !\f_control|i_floor_call_array_down~1_combout\ & ( ((\f_control|Decoder0~7_combout\ & \f_control|i_floor_call_array_down~2_combout\)) # (\f_control|i_floor_call_array_down\(7)) ) )
...
PORT MAP (
	clk => \rtl~0_combout\,
	asdata => \f_control|i_floor_call_array_down~10_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~0_combout\ = ( \state_mach|i_direction~q\ & ( (\state_mach|current_state.idle~q\ & ((!\state_mach|current_state.up~q\) # (!\state_mach|current_state.down~q\))) ) )
...
PORT MAP (
	...
	datac => \f_control|ALT_INV_i_floor_call_array_up\(4),
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~9_combout\ = ( \f_control|Decoder1~7_combout\ & ( (!\f_control|i_floor_call_array_up~1_combout\ & (((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~6_combout\)) # (\f_control|i_floor_call_array_up\(6)))) 
-- ) ) # ( !\f_control|Decoder1~7_combout\ & ( ((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~6_combout\)) # (\f_control|i_floor_call_array_up\(6)) ) )
...
PORT MAP (
	...
	datac => \f_control|ALT_INV_i_floor_call_array_up\(6),
...
-- Equation(s):
-- \state_mach|Mux1~0_combout\ = ( \f_control|i_floor_call_array_up\(5) & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\) # (\f_control|i_floor_call_array_up\(7)) ) ) ) # ( 
-- !\f_control|i_floor_call_array_up\(5) & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (\f_control|i_floor_call_array_up\(7) & \state_mach|i_current_floor[1]~DUPLICATE_q\) ) ) ) # ( \f_control|i_floor_call_array_up\(5) & ( 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_floor_call_array_up\(4))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((\f_control|i_floor_call_array_up\(6)))) ) ) ) # ( 
-- !\f_control|i_floor_call_array_up\(5) & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_floor_call_array_up\(4))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & 
-- ((\f_control|i_floor_call_array_up\(6)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up\(4),
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~5_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( \f_control|i_floor_call_array_up\(2) & ( !\f_control|Decoder1~3_combout\ ) ) ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( 
-- \f_control|i_floor_call_array_up\(2) ) ) # ( \f_control|i_floor_call_array_up~1_combout\ & ( !\f_control|i_floor_call_array_up\(2) & ( (\f_control|i_floor_call_array_up~2_combout\ & (\f_control|Decoder0~2_combout\ & !\f_control|Decoder1~3_combout\)) ) ) ) 
-- # ( !\f_control|i_floor_call_array_up~1_combout\ & ( !\f_control|i_floor_call_array_up\(2) & ( (\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~2_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001000100010001000100000001000011111111111111111111000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	datab => \f_control|ALT_INV_Decoder0~2_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~3_combout\ = ( \f_control|i_floor_call_array_up~1_combout\ & ( (!\f_control|Decoder1~2_combout\ & (((\f_control|Decoder0~0_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(1)))) 
-- ) ) # ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~0_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(1)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000010111111111000001011111111100000100110011000000010011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~0_combout\,
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~4_combout\ = ( \state_mach|Add1~0_combout\ & ( (!\f_control|i_floor_call_array_up~1_combout\ & (((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~1_combout\)) # (\f_control|i_floor_call_array_up\(0)))) ) 
-- ) # ( !\state_mach|Add1~0_combout\ & ( ((\f_control|i_floor_call_array_up~2_combout\ & \f_control|Decoder0~1_combout\)) # (\f_control|i_floor_call_array_up\(0)) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~6_combout\ = ( !\f_control|Decoder1~4_combout\ & ( \f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(3)) ) 
-- ) ) # ( \f_control|Decoder1~4_combout\ & ( !\f_control|i_floor_call_array_up~1_combout\ & ( ((\f_control|Decoder0~3_combout\ & \f_control|i_floor_call_array_up~2_combout\)) # (\f_control|i_floor_call_array_up\(3)) ) ) ) # ( !\f_control|Decoder1~4_combout\ 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001111100011111000111110001111100011111000111110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_Decoder0~3_combout\,
...
-- Equation(s):
-- \state_mach|Mux1~1_combout\ = ( \f_control|i_floor_call_array_up\(3) & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (\f_control|i_floor_call_array_up\(1)) # (\state_mach|i_current_floor[1]~DUPLICATE_q\) ) ) ) # ( !\f_control|i_floor_call_array_up\(3) 
-- & ( \state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & \f_control|i_floor_call_array_up\(1)) ) ) ) # ( \f_control|i_floor_call_array_up\(3) & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( 
-- (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((\f_control|i_floor_call_array_up\(0)))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_floor_call_array_up\(2))) ) ) ) # ( !\f_control|i_floor_call_array_up\(3) & ( 
-- !\state_mach|i_current_floor[0]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor[1]~DUPLICATE_q\ & ((\f_control|i_floor_call_array_up\(0)))) # (\state_mach|i_current_floor[1]~DUPLICATE_q\ & (\f_control|i_floor_call_array_up\(2))) ) ) )
...
-- Equation(s):
-- \f_control|i_floor_call_array_up~1_combout\ = ( \state_mach|Mux1~1_combout\ & ( (!\f_control|i_floor_call_array_up~0_combout\ & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\) # (\state_mach|Mux1~0_combout\))) ) ) # ( !\state_mach|Mux1~1_combout\ & ( 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\f_control|i_floor_call_array_up~0_combout\ & \state_mach|Mux1~0_combout\)) ) )
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000001010100000000000101010011111100111111001111110011111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_up~2_combout\,
	datab => \f_control|ALT_INV_i_floor_call_array_up~1_combout\,
	datac => \state_mach|ALT_INV_Add0~0_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~21_combout\ = (\f_control|i_floor_call_array_up\(7)) # (\f_control|i_floor_call_array_down\(7))
...
-- Equation(s):
-- \state_mach|check_destination_bits~0_combout\ = ( \f_control|i_floor_call_array_up\(2) & ( \f_control|i_floor_call_array_down\(2) ) ) # ( !\f_control|i_floor_call_array_up\(2) & ( \f_control|i_floor_call_array_down\(2) ) ) # ( 
-- \f_control|i_floor_call_array_up\(2) & ( !\f_control|i_floor_call_array_down\(2) ) ) # ( !\f_control|i_floor_call_array_up\(2) & ( !\f_control|i_floor_call_array_down\(2) & ( (((\f_control|i_floor_call_array_up\(0)) # 
-- (\f_control|i_floor_call_array_down\(1))) # (\f_control|i_floor_call_array_down\(0))) # (\f_control|i_floor_call_array_up\(1)) ) ) )
...
PORT MAP (
	...
	dataf => \f_control|ALT_INV_i_floor_call_array_down\(2),
...
-- Equation(s):
-- \state_mach|check_destination_bits~5_combout\ = ( \state_mach|check_destination_bits~1_combout\ & ( (!\state_mach|check_destination_bits~4_combout\) # ((!\state_mach|check_destination_bits~2_combout\) # ((!\state_mach|check_destination_bits~3_combout\) # 
-- (\state_mach|check_destination_bits~0_combout\))) ) ) # ( !\state_mach|check_destination_bits~1_combout\ )
...
-- Equation(s):
-- \state_mach|check_destination_bits~22_combout\ = (\state_mach|check_destination_bits~5_combout\) # (\state_mach|check_destination_bits~21_combout\)
...
-- Equation(s):
-- \state_mach|Selector3~0_combout\ = ( \state_mach|floor_stop~DUPLICATE_q\ & ( \state_mach|current_state.down~q\ ) ) # ( \state_mach|floor_stop~DUPLICATE_q\ & ( !\state_mach|current_state.down~q\ & ( ((!\state_mach|destination~DUPLICATE_q\ & 
-- (\state_mach|floor_call~q\ & !\state_mach|current_state.idle~q\))) # (\state_mach|current_state.up~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001000001111111100000000000000001111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_destination~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_floor_call~q\,
	datac => \state_mach|ALT_INV_current_state.idle~q\,
	datad => \state_mach|ALT_INV_current_state.up~q\,
	datae => \state_mach|ALT_INV_floor_stop~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|Selector1~1_combout\ = ( \state_mach|i_direction~q\ & ( (!\state_mach|floor_stop~DUPLICATE_q\ & \state_mach|current_state.up~q\) ) ) # ( !\state_mach|i_direction~q\ & ( (!\state_mach|floor_stop~DUPLICATE_q\ & 
-- (((\state_mach|current_state.loading~q\ & \state_mach|destination~q\)) # (\state_mach|current_state.up~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000101000101010000010100010101000001010000010100000101000001010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_current_floor~1_combout\ = ( \state_mach|Selector1~1_combout\ & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\state_mach|i_current_floor\(1)) ) ) # ( !\state_mach|Selector1~1_combout\ & ( !\state_mach|i_current_floor[0]~DUPLICATE_q\ $ 
-- (!\state_mach|i_current_floor\(1) $ (((!\state_mach|Selector2~0_combout\) # (\state_mach|i_direction~q\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1101001000101101110100100010110100001111111100000000111111110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_direction~q\,
	datab => \state_mach|ALT_INV_Selector2~0_combout\,
	datac => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	datad => \state_mach|ALT_INV_i_current_floor\(1),
...
-- Equation(s):
-- \state_mach|i_current_floor[2]~2_combout\ = ( \state_mach|Selector1~2_combout\ & ( !\state_mach|i_current_floor\(2) $ (((!\state_mach|i_current_floor[0]~DUPLICATE_q\) # ((!\state_mach|i_current_floor\(1)) # (!\state_mach|i_current_floor~0_combout\)))) ) ) 
-- # ( !\state_mach|Selector1~2_combout\ & ( !\state_mach|i_current_floor\(2) $ ((((!\state_mach|i_current_floor~0_combout\) # (\state_mach|i_current_floor\(1))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000100011110111000010001111011100000001111111100000000111111110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
	datab => \state_mach|ALT_INV_i_current_floor\(1),
	datac => \state_mach|ALT_INV_i_current_floor~0_combout\,
	datad => \state_mach|ALT_INV_i_current_floor\(2),
	dataf => \state_mach|ALT_INV_Selector1~2_combout\,
...
-- Equation(s):
-- \f_control|i_destination_array~5_combout\ = ( \state_mach|Mux0~1_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\f_control|Decoder1~3_combout\ & ((\f_control|i_destination_array\(2)) # (\f_control|i_destination_array~4_combout\))) ) ) ) # ( 
-- !\state_mach|Mux0~1_combout\ & ( \state_mach|Mux0~0_combout\ & ( (!\f_control|i_destination_array~4_combout\ & (\f_control|i_destination_array\(2) & ((!\state_mach|i_current_floor\(2)) # (!\f_control|Decoder1~3_combout\)))) # 
-- (\f_control|i_destination_array~4_combout\ & ((!\state_mach|i_current_floor\(2)) # ((!\f_control|Decoder1~3_combout\)))) ) ) ) # ( \state_mach|Mux0~1_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (!\f_control|i_destination_array~4_combout\ & 
-- (\f_control|i_destination_array\(2) & ((!\f_control|Decoder1~3_combout\) # (\state_mach|i_current_floor\(2))))) # (\f_control|i_destination_array~4_combout\ & (((!\f_control|Decoder1~3_combout\)) # (\state_mach|i_current_floor\(2)))) ) ) ) # ( 
-- !\state_mach|Mux0~1_combout\ & ( !\state_mach|Mux0~0_combout\ & ( (\f_control|i_destination_array\(2)) # (\f_control|i_destination_array~4_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101010111111111010100011111001101010100111111000101000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_direction~6_combout\ = ( \state_mach|check_destination_bits~10_combout\ & ( (!\state_mach|i_current_floor[3]~DUPLICATE_q\ & ((\f_control|i_destination_array\(1)) # (\f_control|i_destination_array\(2)))) ) ) # ( 
-- !\state_mach|check_destination_bits~10_combout\ & ( !\state_mach|i_current_floor[3]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \state_mach|i_direction~13_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (!\f_control|i_destination_array\(3) & ((\f_control|i_destination_array\(5)) # 
-- (\f_control|i_destination_array\(4))))) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & (((\f_control|i_destination_array\(3)) # 
-- (\f_control|i_destination_array\(5))) # (\f_control|i_destination_array\(4)))) ) ) ) # ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & 
-- (((\f_control|i_destination_array\(3)) # (\f_control|i_destination_array\(5))) # (\f_control|i_destination_array\(4)))) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\f_control|i_destination_array\(4) & 
-- ((!\f_control|i_destination_array\(3) & (\f_control|i_destination_array\(5))) # (\f_control|i_destination_array\(3) & ((!\state_mach|i_current_floor[2]~DUPLICATE_q\))))) # (\f_control|i_destination_array\(4) & 
-- (((!\state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111001011110000011100001111000001110000111100000111000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|i_direction~0_combout\ = ( \state_mach|Add1~0_combout\ & ( \state_mach|i_direction~13_combout\ & ( (!\f_control|i_destination_array\(0) & (!\state_mach|i_current_floor[3]~DUPLICATE_q\ & ((!\f_control|i_destination_array\(2)) # 
-- (\f_control|i_destination_array\(1))))) ) ) ) # ( !\state_mach|Add1~0_combout\ & ( \state_mach|i_direction~13_combout\ & ( (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & (!\f_control|i_destination_array\(2) & 
-- !\state_mach|i_current_floor[3]~DUPLICATE_q\))) ) ) ) # ( \state_mach|Add1~0_combout\ & ( !\state_mach|i_direction~13_combout\ & ( (\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & !\state_mach|i_current_floor[3]~DUPLICATE_q\)) 
-- ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010001000000000010000000000000001100010000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(1),
	...
	dataf => \state_mach|ALT_INV_i_direction~13_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~9_combout\ = ( \state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor[3]~DUPLICATE_q\ & ((!\state_mach|i_current_floor\(0)) # (!\state_mach|i_current_floor[2]~DUPLICATE_q\))) ) ) # ( 
-- !\state_mach|i_current_floor\(1) & ( !\state_mach|i_current_floor[3]~DUPLICATE_q\ ) )
...
-- Equation(s):
-- \state_mach|LessThan14~0_combout\ = ( \state_mach|i_current_floor\(1) & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & !\state_mach|i_current_floor[3]~DUPLICATE_q\) ) ) # ( !\state_mach|i_current_floor\(1) & ( 
...
-- Equation(s):
-- \state_mach|i_direction~1_combout\ = ( !\state_mach|i_current_floor[3]~DUPLICATE_q\ & ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & (!\state_mach|i_current_floor\(1) & 
...
-- Equation(s):
-- \state_mach|i_direction~2_combout\ = ( \state_mach|LessThan14~0_combout\ & ( !\state_mach|i_direction~1_combout\ & ( (!\state_mach|check_destination_bits~8_combout\) # ((!\f_control|i_destination_array\(6) & ((!\f_control|i_destination_array\(7)) # 
-- (!\state_mach|check_destination_bits~9_combout\)))) ) ) ) # ( !\state_mach|LessThan14~0_combout\ & ( !\state_mach|i_direction~1_combout\ & ( (!\f_control|i_destination_array\(7)) # ((!\state_mach|check_destination_bits~8_combout\) # 
-- ((!\state_mach|check_destination_bits~9_combout\) # (\f_control|i_destination_array\(6)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111101111111111001110110000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(7),
	...
	datae => \state_mach|ALT_INV_LessThan14~0_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~4_combout\ = ( \state_mach|i_direction~3_combout\ & ( (!\f_control|i_destination_array\(1) & (\state_mach|check_destination_bits~10_combout\ & !\f_control|i_destination_array\(2))) ) ) # ( !\state_mach|i_direction~3_combout\ & ( 
-- (!\f_control|i_destination_array\(1) & (!\f_control|i_destination_array\(0) & (\state_mach|check_destination_bits~10_combout\ & !\f_control|i_destination_array\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000100000000000000010000000000000001010000000000000101000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(1),
...
-- Equation(s):
-- \state_mach|i_direction~14_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(6)) # (\state_mach|i_current_floor\(0)) ) ) ) # ( 
-- !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(6) & ((!\f_control|i_destination_array\(4)) # (\state_mach|i_current_floor\(0)))) ) ) ) # ( 
-- \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\f_control|i_destination_array\(4) & (!\f_control|i_destination_array\(6) & ((!\f_control|i_destination_array\(2)) # (\state_mach|i_current_floor\(0))))) ) 
-- ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100011000000000011001111000000001111111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(2),
...
-- Equation(s):
-- \state_mach|i_direction~5_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_direction~14_combout\ & ( (!\f_control|i_destination_array\(7) & (((!\f_control|i_destination_array\(3) & !\f_control|i_destination_array\(5))) # 
-- (\state_mach|i_current_floor[2]~DUPLICATE_q\))) ) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_direction~14_combout\ & ( (!\f_control|i_destination_array\(5) & (!\f_control|i_destination_array\(7) & 
-- ((!\f_control|i_destination_array\(3)) # (\state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000010000000110000001000000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_destination_array\(3),
...
-- Equation(s):
-- \state_mach|i_direction~7_combout\ = ( \state_mach|i_direction~4_combout\ & ( \state_mach|i_direction~5_combout\ & ( (!\state_mach|i_direction~q\) # ((!\state_mach|i_direction~2_combout\) # (\state_mach|i_direction~0_combout\)) ) ) ) # ( 
-- !\state_mach|i_direction~4_combout\ & ( \state_mach|i_direction~5_combout\ & ( (\state_mach|i_direction~q\ & ((!\state_mach|i_direction~2_combout\) # (\state_mach|i_direction~0_combout\))) ) ) ) # ( \state_mach|i_direction~4_combout\ & ( 
-- !\state_mach|i_direction~5_combout\ & ( (!\state_mach|i_direction~q\) # ((!\state_mach|i_direction~2_combout\) # (\state_mach|i_direction~0_combout\)) ) ) ) # ( !\state_mach|i_direction~4_combout\ & ( !\state_mach|i_direction~5_combout\ & ( 
-- (!\state_mach|i_direction~q\ & (\state_mach|i_direction~6_combout\)) # (\state_mach|i_direction~q\ & (((!\state_mach|i_direction~2_combout\) # (\state_mach|i_direction~0_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111011100100111111111111010111101010101000001011111111110101111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_direction~q\,
	datab => \state_mach|ALT_INV_i_direction~6_combout\,
	datac => \state_mach|ALT_INV_i_direction~0_combout\,
	datad => \state_mach|ALT_INV_i_direction~2_combout\,
	datae => \state_mach|ALT_INV_i_direction~4_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~18_combout\ = ( \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|i_current_floor\(0)) # ((!\f_control|i_floor_call_array_down\(2) & 
-- !\f_control|i_floor_call_array_up\(2))))) ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(3) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~6_combout\ = ( !\f_control|i_floor_call_array_down\(0) & ( (!\f_control|i_floor_call_array_up\(0) & (!\f_control|i_floor_call_array_down\(1) & !\f_control|i_floor_call_array_up\(1))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~11_combout\ = ( !\f_control|i_floor_call_array_down\(2) & ( (!\f_control|i_floor_call_array_up\(2) & (!\f_control|i_floor_call_array_down\(3) & !\f_control|i_floor_call_array_up\(3))) ) )
...
PORT MAP (
	...
	datad => \f_control|ALT_INV_i_floor_call_array_up\(3),
	dataf => \f_control|ALT_INV_i_floor_call_array_down\(2),
...
-- Equation(s):
-- \state_mach|check_destination_bits~12_combout\ = ( \state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(2) & ( (!\state_mach|check_destination_bits~3_combout\) # ((!\state_mach|check_destination_bits~2_combout\) # 
-- ((!\state_mach|check_destination_bits~11_combout\) # (\state_mach|i_current_floor\(0)))) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(2) & ( (!\state_mach|check_destination_bits~11_combout\) # 
-- ((!\state_mach|check_destination_bits~2_combout\ & \state_mach|i_current_floor\(0))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011110000111111001111111011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~3_combout\,
	datab => \state_mach|ALT_INV_check_destination_bits~2_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~11_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~13_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( \state_mach|check_destination_bits~2_combout\ & ( \state_mach|check_destination_bits~1_combout\ ) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~14_combout\ = ( \f_control|i_floor_call_array_up\(0) & ( \state_mach|destination~DUPLICATE_q\ ) ) # ( !\f_control|i_floor_call_array_up\(0) & ( (\state_mach|destination~DUPLICATE_q\ & 
-- (((\f_control|i_floor_call_array_up\(1)) # (\f_control|i_floor_call_array_down\(0))) # (\f_control|i_floor_call_array_down\(1)))) ) )
...
-- Equation(s):
-- \state_mach|check_destination_bits~15_combout\ = ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( \state_mach|i_current_floor\(0) & ( (!\f_control|i_floor_call_array_down\(0) & !\f_control|i_floor_call_array_up\(0)) ) ) ) # ( 
-- \state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) & ( (!\f_control|i_floor_call_array_down\(1) & (!\f_control|i_floor_call_array_down\(0) & (!\f_control|i_floor_call_array_up\(0) & !\f_control|i_floor_call_array_up\(1)))) ) 
-- ) ) # ( !\state_mach|i_current_floor[1]~DUPLICATE_q\ & ( !\state_mach|i_current_floor\(0) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111100000000000000011000000110000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down\(1),
...
-- Equation(s):
-- \state_mach|check_destination_bits~16_combout\ = ( !\state_mach|i_current_floor[3]~DUPLICATE_q\ & ( \f_control|Decoder1~0_combout\ & ( (!\state_mach|check_destination_bits~0_combout\ & (((!\state_mach|i_current_floor[2]~DUPLICATE_q\)) # 
-- (\state_mach|check_destination_bits~1_combout\))) # (\state_mach|check_destination_bits~0_combout\ & (((\state_mach|check_destination_bits~15_combout\ & !\state_mach|i_current_floor[2]~DUPLICATE_q\)))) ) ) ) # ( 
-- !\state_mach|i_current_floor[3]~DUPLICATE_q\ & ( !\f_control|Decoder1~0_combout\ & ( (!\state_mach|i_current_floor[2]~DUPLICATE_q\ & ((!\state_mach|check_destination_bits~0_combout\) # (\state_mach|check_destination_bits~15_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010111100000000000000000000000010101111001000100000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \state_mach|check_destination_bits~17_combout\ = ( \state_mach|LessThan14~0_combout\ & ( \state_mach|check_destination_bits~16_combout\ & ( (\state_mach|check_destination_bits~13_combout\ & (\state_mach|check_destination_bits~3_combout\ & 
-- !\state_mach|check_destination_bits~9_combout\)) ) ) ) # ( !\state_mach|LessThan14~0_combout\ & ( \state_mach|check_destination_bits~16_combout\ & ( (\state_mach|check_destination_bits~13_combout\ & ((!\state_mach|check_destination_bits~3_combout\) # 
-- (!\state_mach|check_destination_bits~9_combout\))) ) ) ) # ( \state_mach|LessThan14~0_combout\ & ( !\state_mach|check_destination_bits~16_combout\ & ( (!\state_mach|check_destination_bits~13_combout\ & 
-- (((!\state_mach|check_destination_bits~14_combout\)))) # (\state_mach|check_destination_bits~13_combout\ & (\state_mach|check_destination_bits~3_combout\ & (!\state_mach|check_destination_bits~9_combout\))) ) ) ) # ( !\state_mach|LessThan14~0_combout\ & ( 
-- !\state_mach|check_destination_bits~16_combout\ & ( (!\state_mach|check_destination_bits~13_combout\ & (((!\state_mach|check_destination_bits~14_combout\)))) # (\state_mach|check_destination_bits~13_combout\ & 
-- ((!\state_mach|check_destination_bits~3_combout\) # ((!\state_mach|check_destination_bits~9_combout\)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111001010100101110100001000001010100010101000001000000010000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~13_combout\,
	datab => \state_mach|ALT_INV_check_destination_bits~3_combout\,
	datac => \state_mach|ALT_INV_check_destination_bits~9_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~19_combout\ = ( \state_mach|check_destination_bits~17_combout\ & ( \state_mach|i_direction~7_combout\ & ( (\state_mach|destination~q\ & (\state_mach|check_destination_bits~6_combout\ & 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000011111111111111110000001000000011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~18_combout\,
	datab => \state_mach|ALT_INV_destination~q\,
	datac => \state_mach|ALT_INV_check_destination_bits~6_combout\,
...
-- Equation(s):
-- \state_mach|i_direction~10_combout\ = ( !\state_mach|check_destination_bits~9_combout\ & ( \state_mach|check_destination_bits~1_combout\ & ( (\state_mach|check_destination_bits~3_combout\ & (\state_mach|check_destination_bits~2_combout\ & 
-- (\state_mach|check_destination_bits~4_combout\ & !\state_mach|check_destination_bits~0_combout\))) ) ) )
...
-- Equation(s):
-- \state_mach|i_direction~9_combout\ = ( \f_control|i_floor_call_array_down\(1) & ( \f_control|i_floor_call_array_up\(1) & ( (\state_mach|i_current_floor\(0)) # (\state_mach|i_current_floor\(1)) ) ) ) # ( !\f_control|i_floor_call_array_down\(1) & ( 
-- \f_control|i_floor_call_array_up\(1) & ( (\state_mach|i_current_floor\(0)) # (\state_mach|i_current_floor\(1)) ) ) ) # ( \f_control|i_floor_call_array_down\(1) & ( !\f_control|i_floor_call_array_up\(1) & ( (\state_mach|i_current_floor\(0)) # 
-- (\state_mach|i_current_floor\(1)) ) ) ) # ( !\f_control|i_floor_call_array_down\(1) & ( !\f_control|i_floor_call_array_up\(1) & ( (\state_mach|i_current_floor\(1) & (((\state_mach|i_current_floor\(0)) # (\f_control|i_floor_call_array_up\(2))) # 
-- (\f_control|i_floor_call_array_down\(2)))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001001100110011001100111111111100110011111111110011001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \f_control|ALT_INV_i_floor_call_array_down\(2),
...
-- Equation(s):
-- \state_mach|i_direction~15_combout\ = ( !\state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (!\state_mach|check_destination_bits~0_combout\ & (!\state_mach|check_destination_bits~1_combout\ & (((\state_mach|i_direction~9_combout\) # 
-- (\f_control|i_floor_call_array_down\(0))) # (\f_control|i_floor_call_array_up\(0))))) # (\state_mach|check_destination_bits~0_combout\ & ((((\state_mach|i_direction~9_combout\)) # (\f_control|i_floor_call_array_down\(0))) # 
-- (\f_control|i_floor_call_array_up\(0)))) ) ) # ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( (((!\state_mach|check_destination_bits~2_combout\) # ((!\state_mach|check_destination_bits~1_combout\)))) # (\state_mach|check_destination_bits~0_combout\) ) 
-- )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0011111100010101111111111111010111111111010101011111111111110101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_check_destination_bits~0_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~20_combout\ = ( \state_mach|check_destination_bits~1_combout\ & ( (\state_mach|check_destination_bits~3_combout\ & (\state_mach|check_destination_bits~2_combout\ & !\state_mach|check_destination_bits~0_combout\)) ) )
...
-- Equation(s):
-- \state_mach|i_direction~11_combout\ = ( !\state_mach|check_destination_bits~0_combout\ & ( !\state_mach|LessThan14~0_combout\ & ( (\state_mach|check_destination_bits~1_combout\ & (\state_mach|check_destination_bits~2_combout\ & 
-- (!\state_mach|check_destination_bits~4_combout\ & \state_mach|check_destination_bits~3_combout\))) ) ) )
...
PORT MAP (
	...
	datae => \state_mach|ALT_INV_check_destination_bits~0_combout\,
	dataf => \state_mach|ALT_INV_LessThan14~0_combout\,
	combout => \state_mach|i_direction~11_combout\);

-- Location: LABCELL_X61_Y7_N18
\state_mach|i_direction~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|i_direction~8_combout\ = ( \state_mach|i_current_floor[2]~DUPLICATE_q\ & ( !\state_mach|check_destination_bits~0_combout\ & ( (\state_mach|check_destination_bits~1_combout\ & (\state_mach|check_destination_bits~2_combout\ & 
-- ((\state_mach|i_current_floor\(1)) # (\state_mach|i_current_floor\(0))))) ) ) )
...
-- Equation(s):
-- \state_mach|i_direction~12_combout\ = ( \state_mach|i_direction~11_combout\ & ( \state_mach|i_direction~8_combout\ ) ) # ( !\state_mach|i_direction~11_combout\ & ( \state_mach|i_direction~8_combout\ & ( (!\state_mach|check_destination_bits~20_combout\) # 
-- (\state_mach|i_direction~10_combout\) ) ) ) # ( \state_mach|i_direction~11_combout\ & ( !\state_mach|i_direction~8_combout\ ) ) # ( !\state_mach|i_direction~11_combout\ & ( !\state_mach|i_direction~8_combout\ & ( 
-- ((!\state_mach|check_destination_bits~20_combout\ & ((\state_mach|i_direction~15_combout\) # (\state_mach|i_current_floor\(3))))) # (\state_mach|i_direction~10_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111111100110011111111111111111111111111001100111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor\(3),
	datab => \state_mach|ALT_INV_i_direction~10_combout\,
	datac => \state_mach|ALT_INV_i_direction~15_combout\,
	datad => \state_mach|ALT_INV_check_destination_bits~20_combout\,
	datae => \state_mach|ALT_INV_i_direction~11_combout\,
...
-- Equation(s):
-- \state_mach|check_destination_bits~28_combout\ = ( !\state_mach|check_destination_bits~5_combout\ & ( (!\state_mach|check_destination_bits~21_combout\ & (\state_mach|i_direction~7_combout\)) # (\state_mach|check_destination_bits~21_combout\ & 
-- ((!\state_mach|destination~DUPLICATE_q\ & ((!\state_mach|i_direction~12_combout\) # ((\state_mach|i_direction~7_combout\ & !\state_mach|i_current_floor[3]~DUPLICATE_q\)))) # (\state_mach|destination~DUPLICATE_q\ & (\state_mach|i_direction~7_combout\)))) ) 
...
GENERIC MAP (
	extended_lut => "on",
	lut_mask => "0101111101010101111111110101010101010100010101010000111100001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_direction~7_combout\,
...
\state_mach|floor_stop~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|floor_stop~1_combout\ = ( \state_mach|Mux1~1_combout\ & ( (!\state_mach|current_state.idle~q\ & (((!\state_mach|i_current_floor\(2)) # (\state_mach|Mux1~0_combout\)))) # (\state_mach|current_state.idle~q\ & (!\state_mach|i_direction~q\ & 
-- ((!\state_mach|i_current_floor\(2)) # (\state_mach|Mux1~0_combout\)))) ) ) # ( !\state_mach|Mux1~1_combout\ & ( (\state_mach|Mux1~0_combout\ & (\state_mach|i_current_floor\(2) & ((!\state_mach|current_state.idle~q\) # (!\state_mach|i_direction~q\)))) ) )
...
PORT MAP (
	...
	datad => \state_mach|ALT_INV_i_current_floor\(2),
	dataf => \state_mach|ALT_INV_Mux1~1_combout\,
	combout => \state_mach|floor_stop~1_combout\);

-- Location: LABCELL_X63_Y8_N21
\state_mach|floor_stop~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|floor_stop~0_combout\ = ( \state_mach|Mux2~0_combout\ & ( (!\state_mach|current_state.idle~q\ & (((\state_mach|Mux2~1_combout\) # (\state_mach|i_current_floor\(2))))) # (\state_mach|current_state.idle~q\ & (\state_mach|i_direction~q\ & 
-- ((\state_mach|Mux2~1_combout\) # (\state_mach|i_current_floor\(2))))) ) ) # ( !\state_mach|Mux2~0_combout\ & ( (!\state_mach|i_current_floor\(2) & (\state_mach|Mux2~1_combout\ & ((!\state_mach|current_state.idle~q\) # (\state_mach|i_direction~q\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010110000000000001011000000001011101110110000101110111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~q\,
	datab => \state_mach|ALT_INV_i_direction~q\,
	datac => \state_mach|ALT_INV_i_current_floor\(2),
	datad => \state_mach|ALT_INV_Mux2~1_combout\,
	dataf => \state_mach|ALT_INV_Mux2~0_combout\,
	combout => \state_mach|floor_stop~0_combout\);

-- Location: LABCELL_X63_Y8_N51
\state_mach|floor_stop~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|floor_stop~2_combout\ = ( \state_mach|floor_stop~0_combout\ ) # ( !\state_mach|floor_stop~0_combout\ & ( ((!\state_mach|i_current_floor\(2) & (\state_mach|Mux0~1_combout\)) # (\state_mach|i_current_floor\(2) & ((\state_mach|Mux0~0_combout\)))) 
-- # (\state_mach|floor_stop~1_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101110101111111010111010111111111111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_floor_stop~1_combout\,
	datab => \state_mach|ALT_INV_i_current_floor\(2),
	datac => \state_mach|ALT_INV_Mux0~1_combout\,
	datad => \state_mach|ALT_INV_Mux0~0_combout\,
	dataf => \state_mach|ALT_INV_floor_stop~0_combout\,
	combout => \state_mach|floor_stop~2_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	d => \state_mach|floor_stop~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|Selector0~0_combout\ = ( \state_mach|floor_call~q\ & ( (!\state_mach|destination~q\ & (((!\state_mach|current_state.loading~q\)))) # (\state_mach|destination~q\ & ((!\state_mach|floor_stop~DUPLICATE_q\) # 
-- ((!\state_mach|current_state.loading~q\ & \state_mach|current_state.idle~q\)))) ) ) # ( !\state_mach|floor_call~q\ & ( (!\state_mach|floor_stop~DUPLICATE_q\ & (((!\state_mach|current_state.loading~q\ & \state_mach|current_state.idle~q\)) # 
-- (\state_mach|destination~q\))) # (\state_mach|floor_stop~DUPLICATE_q\ & (!\state_mach|current_state.loading~q\ & (\state_mach|current_state.idle~q\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110010101110000011001010111011001100101011101100110010101110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_floor_stop~DUPLICATE_q\,
...
-- Equation(s):
-- \state_mach|Selector2~0_combout\ = ( \state_mach|floor_call~q\ & ( (!\state_mach|current_state.idle~q\ & !\state_mach|floor_stop~DUPLICATE_q\) ) ) # ( !\state_mach|floor_call~q\ & ( (!\state_mach|current_state.idle~q\ & 
-- (!\state_mach|floor_stop~DUPLICATE_q\ & \state_mach|destination~q\)) ) )
...
\state_mach|Selector1~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \state_mach|Selector1~2_combout\ = ( \state_mach|Selector1~1_combout\ ) # ( !\state_mach|Selector1~1_combout\ & ( (\state_mach|Selector2~0_combout\ & !\state_mach|i_direction~q\) ) )
...
PORT MAP (
	...
	dataf => \state_mach|ALT_INV_Selector1~1_combout\,
	combout => \state_mach|Selector1~2_combout\);
...
PORT MAP (
	clk => \rtl~0_combout\,
	asdata => \state_mach|Selector1~2_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \state_mach|i_current_floor~0_combout\ = ( \state_mach|Selector1~0_combout\ & ( (!\state_mach|floor_stop~q\) # (\state_mach|Selector2~0_combout\) ) ) # ( !\state_mach|Selector1~0_combout\ & ( ((!\state_mach|floor_stop~q\ & 
-- ((\state_mach|current_state.down~q\) # (\state_mach|current_state.up~q\)))) # (\state_mach|Selector2~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100111111001111010011111100111111001111110011111100111111001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.up~q\,
...
-- Equation(s):
-- \hexF|Mux6~0_combout\ = ( \state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor\(2) & !\state_mach|i_current_floor\(1)) ) ) # ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & 
-- (!\state_mach|i_current_floor\(2))) # (\state_mach|i_current_floor[0]~DUPLICATE_q\ & ((\state_mach|i_current_floor\(1)) # (\state_mach|i_current_floor\(2)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010010111110101101001011111010111110000000000001111000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|segs[0]~0_combout\ = ( \state_mach|current_state.down~q\ & ( (!\hexF|Mux6~0_combout\) # ((!\state_mach|current_state.idle~q\) # (\state_mach|current_state.up~q\)) ) ) # ( !\state_mach|current_state.down~q\ & ( (!\hexF|Mux6~0_combout\) # 
-- ((!\state_mach|current_state.up~q\) # (!\state_mach|current_state.idle~q\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111100111111111111110011111111110011111111111111001111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \hexF|ALT_INV_Mux6~0_combout\,
	datac => \state_mach|ALT_INV_current_state.up~q\,
	datad => \state_mach|ALT_INV_current_state.idle~q\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux5~0_combout\ = ( \state_mach|i_current_floor\(2) & ( (!\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\state_mach|i_current_floor\(1))) # (\state_mach|i_current_floor\(3)) ) ) # ( !\state_mach|i_current_floor\(2) & ( 
-- (\state_mach|i_current_floor\(3) & \state_mach|i_current_floor\(1)) ) )
...
-- Equation(s):
-- \hexF|Mux5~1_combout\ = ( \state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # ((\state_mach|current_state.down~q\) # (\hexF|Mux5~0_combout\)) ) ) # ( !\state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # 
-- ((!\state_mach|current_state.down~q\) # (\hexF|Mux5~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111110101111111111111010111110101111111111111010111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~q\,
...
-- Equation(s):
-- \hexF|Mux4~0_combout\ = ( \state_mach|i_current_floor\(3) & ( (\state_mach|i_current_floor\(1)) # (\state_mach|i_current_floor\(2)) ) ) # ( !\state_mach|i_current_floor\(3) & ( (!\state_mach|i_current_floor\(2) & 
-- (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & \state_mach|i_current_floor\(1))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011000000000000001100000000110011111111110011001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor\(2),
...
-- Equation(s):
-- \hexF|Mux4~1_combout\ = ( \state_mach|current_state.down~q\ & ( ((!\state_mach|current_state.idle~q\) # (\state_mach|current_state.up~q\)) # (\hexF|Mux4~0_combout\) ) ) # ( !\state_mach|current_state.down~q\ & ( ((!\state_mach|current_state.up~q\) # 
-- (!\state_mach|current_state.idle~q\)) # (\hexF|Mux4~0_combout\) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111110101111111111111010111111111010111111111111101011111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \hexF|ALT_INV_Mux4~0_combout\,
	datac => \state_mach|ALT_INV_current_state.up~q\,
	datad => \state_mach|ALT_INV_current_state.idle~q\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux3~0_combout\ = ( \state_mach|i_current_floor\(2) & ( (!\state_mach|i_current_floor\(3) & (!\state_mach|i_current_floor[0]~DUPLICATE_q\ $ (!\state_mach|i_current_floor\(1)))) ) ) # ( !\state_mach|i_current_floor\(2) & ( 
-- (!\state_mach|i_current_floor\(1) & (!\state_mach|i_current_floor[0]~DUPLICATE_q\)) # (\state_mach|i_current_floor\(1) & ((!\state_mach|i_current_floor\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101011110000101010101111000001010000101000000101000010100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_i_current_floor[0]~DUPLICATE_q\,
...
-- Equation(s):
-- \hexF|segs[3]~1_combout\ = ( \state_mach|current_state.down~q\ & ( ((!\state_mach|current_state.idle~q\) # (!\hexF|Mux3~0_combout\)) # (\state_mach|current_state.up~q\) ) ) # ( !\state_mach|current_state.down~q\ & ( (!\state_mach|current_state.idle~q\) # 
-- ((\state_mach|current_state.up~q\ & !\hexF|Mux3~0_combout\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001111110000111100111111000011111111111100111111111111110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_current_state.up~q\,
	datac => \state_mach|ALT_INV_current_state.idle~q\,
	datad => \hexF|ALT_INV_Mux3~0_combout\,
	dataf => \state_mach|ALT_INV_current_state.down~q\,
...
-- Equation(s):
-- \hexF|Mux2~0_combout\ = ( \state_mach|i_current_floor\(2) & ( (!\state_mach|i_current_floor\(3) & (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & \state_mach|i_current_floor\(1))) ) ) # ( !\state_mach|i_current_floor\(2) & ( 
-- (!\state_mach|i_current_floor[0]~DUPLICATE_q\ & ((!\state_mach|i_current_floor\(3)) # (!\state_mach|i_current_floor\(1)))) ) )
...
-- Equation(s):
-- \hexF|segs[4]~2_combout\ = ( \state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # ((!\hexF|Mux2~0_combout\) # (\state_mach|current_state.down~q\)) ) ) # ( !\state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # 
-- ((!\hexF|Mux2~0_combout\ & \state_mach|current_state.down~q\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1010101011111010101010101111101011111010111111111111101011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~q\,
...
-- Equation(s):
-- \hexF|Mux1~0_combout\ = ( \state_mach|i_current_floor\(2) & ( (!\state_mach|i_current_floor\(3) & ((!\state_mach|i_current_floor[0]~DUPLICATE_q\) # (!\state_mach|i_current_floor\(1)))) ) ) # ( !\state_mach|i_current_floor\(2) & ( 
-- (!\state_mach|i_current_floor\(1) & ((!\state_mach|i_current_floor[0]~DUPLICATE_q\) # (\state_mach|i_current_floor\(3)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111001100000000111100110000000011001100110000001100110011000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_i_current_floor\(3),
...
-- Equation(s):
-- \hexF|segs[5]~3_combout\ = ( \state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # ((!\hexF|Mux1~0_combout\) # (\state_mach|current_state.down~q\)) ) ) # ( !\state_mach|current_state.up~q\ & ( (!\state_mach|current_state.idle~q\) # 
-- ((!\hexF|Mux1~0_combout\ & \state_mach|current_state.down~q\)) ) )
...
PORT MAP (
	dataa => \state_mach|ALT_INV_current_state.idle~q\,
	datac => \hexF|ALT_INV_Mux1~0_combout\,
	datad => \state_mach|ALT_INV_current_state.down~q\,
	dataf => \state_mach|ALT_INV_current_state.up~q\,
...
-- Equation(s):
-- \hexF|Mux0~0_combout\ = ( \state_mach|i_current_floor\(1) & ( \state_mach|i_current_floor\(2) & ( (\state_mach|i_current_floor[0]~DUPLICATE_q\ & !\state_mach|i_current_floor\(3)) ) ) ) # ( !\state_mach|i_current_floor\(1) & ( 
...
-- Equation(s):
-- \hexF|segs[6]~4_combout\ = ( \state_mach|current_state.idle~q\ & ( \state_mach|current_state.down~q\ & ( (!\state_mach|current_state.up~q\ & \hexF|Mux0~0_combout\) ) ) ) # ( \state_mach|current_state.idle~q\ & ( !\state_mach|current_state.down~q\ & ( 
-- (!\state_mach|current_state.up~q\) # (\hexF|Mux0~0_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000110011111100111100000000000000000000110000001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \state_mach|ALT_INV_current_state.up~q\,
